...
class ReasoningTool:
    """Complexity Theory x pgmpy_acids - Simpson Paradox"""
    ...
    def _reason(self, structure):
        ...
        if confounder:
            updated_prob = conditional_query(model, [best[0]], {confounder: True})
            return {"answer": best[0], "confidence": updated_prob, "reasoning": "Simpson's paradox detected"}
        else:
            return {"answer": best[0], "confidence": 0.8, "reasoning": "No paradox detected"}
