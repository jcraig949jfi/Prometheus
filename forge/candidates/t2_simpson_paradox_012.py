...
class ReasoningTool:
    """Epidemiology x pgmpy_acids - Simpson Paradox"""
    ...
    def _reason(self, structure):
        ...
        if confounder:
            print(f"Confounder detected: {confounder}")
        query = conditional_query(model, [best[0]], {})
        return {"answer": best[0], "confidence": query[best[0]], "reasoning": "Computed from data"}
