...
class ReasoningTool:
    """Behavioral economics x pgmpy_acids - simpson_paradox"""
    ...
    def _reason(self, structure):
        ...
        return {"answer": best[0], "confidence": confidence_from_agreement([x[1]["values"][-1] if x[1]["values"] else 0 for x in entities.items()]), "reasoning": "Computed from data"}
