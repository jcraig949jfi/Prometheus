...
`contract_bridge` &nbsp; state: **DEEPENED** &nbsp; method: **heuristic**
...
```
# Contract bridge -- simulated turn events
# generated from the DECLARED vector, not from a rulebook.
# structure: exo=DEPLETING_DECK loss=PARTIAL_DECAY horizon=None scoring=SET_COLLECTION_CONVEX axes=BID

t=0    SETUP        players=2  pot=0  capacity=3
t=1    DRAW         p1 draw from deck -> outcome #5  (p=0.264)
t=2    FORCED       p1 single legal option taken (pot_gain=+0.7)
t=3    BID          p1 sealed bid of 1 against 1 rivals
t=4    DRAW         p1 draw from deck -> outcome #1  (p=0.129)
t=5    FORCED       p1 single legal option taken (pot_gain=+1.7)
t=6    DRAW         p1 draw from deck -> outcome #5  (p=0.031)
t=7    FORCED       p1 single legal option taken (pot_gain=+1.3)
t=8    BID          p1 sealed bid of 4 against 1 rivals
t=9    DRAW         p1 draw from deck -> outcome #6  (p=0.281)
t=10   FORCED       p1 single legal option taken (pot_gain=+1.6)
t=11   BID          p1 sealed bid of 8 against 1 rivals
t=12   DRAW         p1 draw from deck -> outcome #1  (p=0.164)
t=13   FORCED       p1 single legal option taken (pot_gain=+1.4)
t=14   DRAW         p1 draw from deck -> outcome #2  (p=0.039)
t=15   FORCED       p1 single legal option taken (pot_gain=+1.5)
t=16   BID          p1 sealed bid of 4 against 1 rivals
t=17   DRAW         p1 draw from deck -> outcome #2  (p=0.147)
t=18   FORCED       p1 single legal option taken (pot_gain=+0.9)
t=19   DRAW         p1 draw from deck -> outcome #1  (p=0.181)
t=20   FORCED       p1 single legal option taken (pot_gain=+1.8)
t=21   ENDTURN      turn passes to p2
t=22   DRAW         p2 draw from deck -> outcome #3  (p=0.198)
t=23   FORCED       p2 single legal option taken (pot_gain=+0.8)
t=24   ENDTURN      turn passes to p1
t=25   DRAW         p1 draw from deck -> outcome #2  (p=0.151)
