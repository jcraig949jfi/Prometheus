...
`queendomino` &nbsp; state: **DEEPENED** &nbsp; method: **heuristic**
...
```
# Queendomino -- simulated turn events
...
t=5    SPATIAL      p2 places at (5,0); adjacency legal
...
t=27   SPATIAL      p2 places at (6,5); adjacency legal
