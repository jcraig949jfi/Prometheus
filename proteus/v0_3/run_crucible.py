"""V0.3 no-selection crucible and its null controls. One arm per invocation.

    python proteus/v0_3/run_crucible.py NC1|NC2|NC3|V0_3|NC4

Refuses to run against any grammar or runtime other than the ones in PREREG_V0_3.json.
...
def run_arm(arm: str, pre: dict):
    ...
    cap = d["tape_words"] // IW
    root = SplitMix64(seed_from("proteus.v0_3.crucible", pre["seed"], arm, grammar.GRAMMAR_HASH))
