"""Neutral diffusion census (brief section 5). No world, no fitness, no selection, no filtering.
...
geometry of the space rather than against an invented floor.
    ...
    python proteus/v0_3/run_diffusion.py
"""
...
def main():
    ...
    result = {
        "schema_version": "proteus.diffusion_census.v0_3",
