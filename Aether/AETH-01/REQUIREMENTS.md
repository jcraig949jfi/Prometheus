...
| R6 endogenous construction | SATISFIED (by design intent) | Physics permits the STRUCTURAL_RESEMBLANCE / CAUSAL_VALUE_CONSTRUCTION / CONSTRUCTED_CAPACITY / RECURSIVE_CONSTRUCTION distinction to be made later (HEREDITY_REQUIREMENTS.md); no detector exists yet, which is explicitly allowed by the brief |
