...
VERBATIM COPY of Aether/test/reference/oracle_aeth01.py, bundled here so
the RunPod canary pod can verify against the SAME CPU reference without
a network dependency at run time. Do not edit this file independently
of the source; if the source changes, re-copy it here byte-for-byte
(README.md "Package inventory").
"""
