...
## A. STARTUP (preregistration; sealed sha256:d776fcd3c7430568898ab3f60c60cdc4e2c3109c3ab4171c0bd2512bba3692fa)
...
- REACHABILITY ESTIMATE:
    {"W1_d1": {"at_budget": {"band95": [0.2077, 0.9385], "class": "REACHABLE", "first_solved_gens": [49, 79], "freq": 0.6667, "k": 2, "n": 3}, "pooled_any_budget": {"band95": [0.0822, 0.6411], "budgets": [[20, 6, 4], [200, 100, 24]], "class": "REACHABLE", "freq": 0.2857, "k": 2, "n": 7}}, "W1_d4": {"at_budget": {"band95": [0.0, 0.5615], "class": "OBSERVED_UNREACHABLE_AT_BUDGET", "first_solved_gens": [], "freq": 0.0, "k": 0, "n": 3}, "pooled_any_budget": {"band95": [0.0, 0.3543], "budgets": [[20, 6, 4], [200, 100, 24]], "class": "OBSERVED_UNREACHABLE_AT_BUDGET", "freq": 0.0, "k": 0, "n": 7}}}
- ARMS:
    - A_words/control
    - A_words/stuck
    - B_fields/control
...
- BUDGET:
    {"E": 24, "G": 100, "N": 200, "gate_min": 2, "heldout_episodes": 48, "seeds": [1, 2, 3, 4, 5, 6]}
...
- timings (s): records_s=1.62, stage1_s=68.89, startup_s=0.1, teardown_s=0.2, total_s=71.8
...
- primary table:
    ...
    A_words/control          1.000   0.000   0.021   0.000   0.000   0.000   0.170    6

    arm / train_last            s1      s2      s3      s4      s5      s6    mean    n
    A_words/control          1.000   0.042   0.000   0.000   0.000   0.000   0.174    6
...
- footholds:
    ...
    A_words/control        1/6        99,-,-,-,-,-

- typed states fired: ['POSITIVE_CONTROL_FAILED']
    POSITIVE_CONTROL_FAILED  {"arm": "A_words/control", "metric": "reached", "min": 1, "rows": 6, "rows_meeting": 1, "values": [1, 0, 0, 0, 0, 0]}
