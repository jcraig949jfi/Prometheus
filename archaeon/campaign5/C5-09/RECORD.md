...
- timings (s): arms_s=413.68, startup_s=0.07, teardown_s=0.03, total_s=550.1
...
- typed states fired: ['POSITIVE_CONTROL_FAILED', 'UNDERPOWERED']
    POSITIVE_CONTROL_FAILED  {"arm": "controls", "metric": "pass", "min": 1.0, "rows": 1, "rows_meeting": 0, "values": [0.0]}
