...
- timings (s): records_s=0.0, search_s=1.24, total_s=1.4
...
- primary table:
    ...
    arm / confirmed_gen         s1      s2    mean    n
    grammar                      -       -       -    0
    high_basin                   -       -       -    0
    low_basin                    -       -       -    0
    rand_a                       -       -       -    0
    ...
    arm / solved                s1      s2    mean    n
    grammar                      0       0   0.000    2
    high_basin                   0       0   0.000    2
    low_basin                    0       0   0.000    2
    rand_a                       0       0   0.000    2
    rand_b                       0       0   0.000    2

    arm / best_g20              s1      s2    mean    n
    grammar                  0.125   0.188   0.156    2
    high_basin               0.125   0.188   0.156    2
    low_basin                0.125   0.188   0.156    2
    rand_a                   0.125   0.188   0.156    2
    rand_b                   0.125   0.188   0.156    2

    arm / competence_heldout      s1      s2    mean    n
    grammar                  0.062   0.042   0.052    2
    high_basin               0.062   0.042   0.052    2
    low_basin                0.062   0.042   0.052    2
    rand_a                   0.062   0.042   0.052    2
    rand_b                   0.062   0.042   0.052    2

- typed states fired: ['POSITIVE_CONTROL_FAILED']
    POSITIVE_CONTROL_FAILED  {"arm": "grammar", "metric": "confirmed", "min": 1, "rows": 2, "rows_meeting": 0, "values": [0, 0]}
- disposition candidate (machine): POSITIVE_CONTROL_FAILED -- assay precondition failed; the scientific question was not posed
- claim ceiling (machine): none; preregistered ceiling: one task, one genotype-space slice (the opcode field), n=2 paired seeds, and a SMALL geometric difference (the informative table's encodings span a 32% relative range in basin share): whether a preregistered geometric difference moves realized search efficiency in the predicted direction; no claim that basin share is THE explanatory variable, and a null here does not separate 'geometry is inert' from 'this gap is too small'
