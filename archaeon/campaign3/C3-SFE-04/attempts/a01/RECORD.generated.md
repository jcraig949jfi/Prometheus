...
- timings (s): direct_s=0.71, harvest_s=2.36, phase1_s=3.08, records_s=0.0, search_s=14.92, total_s=18.5
...
- primary table:
    ...
    baseline                 0.042   0.031   0.036    2
    init_control             0.042   0.021   0.031    2
    init_mature              0.177   0.271   0.224    2

    arm / first_foothold_gen      s1      s2    mean    n
    baseline                     -       -       -    0
    init_control                 -       -       -    0
    init_mature                  -       -       -    0
    ...
    arm / summit                s1      s2    mean    n
    baseline                     0       0   0.000    2
    init_control                 0       0   0.000    2
    init_mature                  0       0   0.000    2
...
- disposition candidate (machine): WEAK_POSITIVE -- effect >= min_effect but n < 10 or a declared falsification attack failed or was not run
    evidence: {"control_mean": 0.0, "effect": 0.6667, "min_effect": 0.25, "n_control": 6, "n_treatment": 6, "paired": 2, "paired_wins": 0, "treatment_mean": 0.6667}
    battery: {"attacked": 3, "declared": 3, "survived": 2}
- claim ceiling (machine): weak; not for propagation; preregistered ceiling: a sparse map at n=2 per edge and G=10: which edges show a measurable initialization advantage over a matched baseline, with the permuted control as the capability test; no claim that the advantage transfers structure rather than search time
