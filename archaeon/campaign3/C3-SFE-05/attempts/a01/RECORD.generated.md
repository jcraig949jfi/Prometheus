...
## A. STARTUP (preregistration; sealed sha256:0d1f162c090d9261dfe59014f454e53be0695407be4791d4e0ac22f9225d71bd)
...
- ASSAY CAPABILITY REQUIREMENT: the p0 arm reaches rung-0 competence >= 0.5 within the first rung in >= 6 of 2 seeds (else POSITIVE_CONTROL_FAILED)
- POSITIVE CONTROL: rung-0 arrival under p0 (W0 4-bit, table 11/21 by G30)
...
- BUDGET:
    {"E": 4, "G": 16, "N": 24, "general_min": 0.75, "probe_dense": 5, "probe_sparse": 5, "rung_gens": 4, "seeds": [1, 2], "shares": [0.0, 0.05, 0.1, 0.2]}
...
- CLAIM CEILING: weak at n=2: a break-even REGION (the smallest p with final_r0 not below p0.1's by 0.15) and a yes/no on post-generality removal
...
- KILL CONDITION: positive control fails; or p0 retains rung 0 in >= 8/2 seeds (no cliff to price)
...
- decl (machine-read by archaeon.wse.states): {"n_min": 2, "positive_control": {"arm": "p0.0", "metric": "reached_r0_by_rung_end", "min": 1, "min_rows": 6}, "primary": {"control": "p0.0", "metric": "final_r0", "min_effect": 0.15, "treatment": "p0.05"}}
...
- timings (s): ladder_s=1.66, records_s=0.0, total_s=1.9
...
- primary table:
    ...
    p0.0                     0.000   0.083   0.042    2
    p0.05                    0.000   0.083   0.042    2
    p0.1                     0.000   0.083   0.042    2
    p0.1_then_0              0.000   0.083   0.042    2
    p0.2                     0.000   0.083   0.042    2

    arm / final_r3              s1      s2    mean    n
    p0.0                     0.167   0.042   0.104    2
    p0.05                    0.167   0.042   0.104    2
    p0.1                     0.167   0.042   0.104    2
    p0.1_then_0              0.167   0.042   0.104    2
    p0.2                     0.167   0.042   0.104    2
    ...
    arm / revisit_cost_episodes      s1      s2    mean    n
    p0.0                         0       0   0.000    2
    p0.05                        0       0   0.000    2
    p0.1                         0       0   0.000    2
    p0.1_then_0                  0       0   0.000    2
    p0.2                        12      12  12.000    2
...
- typed states fired: ['POSITIVE_CONTROL_FAILED']
    POSITIVE_CONTROL_FAILED  {"arm": "p0.0", "metric": "reached_r0_by_rung_end", "min": 1, "rows": 2, "rows_meeting": 1, "values": [0, 1]}
- disposition candidate (machine): POSITIVE_CONTROL_FAILED -- assay precondition failed; the scientific question was not posed
- claim ceiling (machine): none; preregistered ceiling: weak at n=2: a break-even REGION (the smallest p with final_r0 not below p0.1's by 0.15) and a yes/no on post-generality removal
