...
INVARIANCE = {
    ...
    "F043": {"P020": +2, "P023": +2, "P038": 0, "P036": -1},                                                   # U_D corr(log Sha, log A)=-0.520 at rank 0; candidate new empirical BSD relation. NOT conditioning tautology. P036 -1: F043 is on rank-0 subset where root_number = +1 constant, no stratification possible. Re-auditor 2026-04-19: BLOCK-SHUFFLE VERIFIED at z=-348.05 (n=559386 rank-0 decade [1e5,1e6)) — observed corr=-0.4343, null_mean~0, null_std=0.0012. P020 and P023 promoted +1→+2. P023 vacuous (rank-0-defined) but inherits P020 verdict. P038 Sha stratification demoted +1→0 — F043 is defined as a correlation involving log(Sha); stratifying by Sha is self-referential, not independent structure.
