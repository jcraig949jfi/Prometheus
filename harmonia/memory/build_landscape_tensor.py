...
INVARIANCE = {
    ...
    "F042": {"P025": 0, "P020": 0, "P037": -1, "P039": +1},                                                    # CM disc=-27 quantitative precision on known qualitative structure (Gross 1980, RVZ 1993). P037 Sato-Tate → N(U(1)) by CM hypothesis (tautological). P039 +1 via CM curves having characteristic nonmax_primes structure. Re-auditor 2026-04-18: P020, P025 demoted +1→0 — per sessionC literature scan (c9a7543a), F042 6.66x depression is Deuring non-maximal-order character-sum compression (Gross LNM); known qualitative effect, no novel structure. Retained as documented but not +1.
    ...
    "F043": {"P020": +2, "P023": +2, "P038": +1, "P036": -1},                                                  # U_D corr(log Sha, log A)=-0.520 at rank 0; candidate new empirical BSD relation. NOT conditioning tautology. P036 -1: F043 is on rank-0 subset where root_number = +1 constant, no stratification possible. Re-auditor 2026-04-19: BLOCK-SHUFFLE VERIFIED at z=-348.05 (n=559386 rank-0 decade [1e5,1e6)) — observed corr=-0.4343, null_mean~0, null_std=0.0012. P020 and P023 promoted +1→+2. P023 vacuous (rank-0-defined) but inherits P020 verdict.
