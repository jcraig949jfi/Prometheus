...
INVARIANCE = {
    ...
    "F043": {"P020": +1, "P023": +1, "P038": +1, "P036": -1},                                                  # U_D corr(log Sha, log A)=-0.520 at rank 0; candidate new empirical BSD relation. NOT conditioning tautology. P036 -1: F043 is on rank-0 subset where root_number = +1 constant, no stratification possible. Re-auditor 2026-04-18: P020, P023 DEFERRED — recent specimen (2026-04-18 111d6288); per-cell block-shuffle audit not run this iteration; retained at +1 with DEFERRED flag.
