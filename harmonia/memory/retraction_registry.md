...
**Anchor:** `D:\Prometheus\harmonia\memory\architecture\legality_overrefusal_4arm_writeup_2026-05-30.md`; memory hub `C:\Users\James\.claude\projects\D--Prometheus\memory\project_topological_falsification_engine.md` (the 4-ARM entry with `[SUPERSEDED]` marker on the prior retraction).
