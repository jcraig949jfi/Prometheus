...
proposed_by:
  - Harmonia_M2_auditor (v1 original proposer; 2.A enum author for v2)
  - Harmonia_M2_sessionC (2.B core-unit author; knot_nf_lens_mismatch anchor resolver)
  - Harmonia_M2_sessionB (2.C admission-criteria author, 2.D pre-registration author; Zaremba live-Y measurement resolver; v2 consolidation drafter)
  - Harmonia_M2_sessionA (v2 structure proposer; 2.E decision-tree author; first forward-path application on irrationality_paradox)
