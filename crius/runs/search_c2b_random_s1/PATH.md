PATH EVIDENCE run=search_c2b_random_s1 arm=random
PARTS-op frequencies (candidates per window of 50 iterations executing the op at least once on a stream)
  window   n   rec   inv  plan  rec+inv  rec+inv+plan  ownInvoke(solved>seed)
     0- 49 1184   478   355     0      155             0        0
    50- 99 1200   719    65     0       51             0        0
   100-149 1200     3    34     0        1             0        0
   150-199 1200    14     9     0        1             0        0
   200-249 1200    10     7     0        0             0        0
   250-299 1200    18    19     0        0             0        0
   300-300   24     6     3     0        0             0        0
Survival of typed ops in the ELITE (top 8 by fitness per iteration): iterations present / longest consecutive run
  recorder  present in 77/301 iterations; longest consecutive run 50
  invoker   present in 54/301 iterations; longest consecutive run 23
...
Selectable foothold: children's fitness minus parent's, by typed op carried (same iteration streams do not
  ...
  recorder  newly carried by    73 children: mean delta -1.709, improved   18 (24.7 pct) | others: mean -0.873, improved 34.9 pct
  invoker   newly carried by   121 children: mean delta -0.813, improved   55 (45.5 pct) | others: mean -0.883, improved 34.6 pct
