...
def execute_attack(problem: dict, attack_plan_path: Optional[str] = None) -> dict:
    ...
    if problem_id.startswith("EREBOS-"):
        try:
            ...
            import charon.agents.stygian.loaders.composition_g02_lehmer_multi_binary_wy  # noqa: F401
            ...
            import charon.agents.stygian.loaders.composition_g10_lehmer_bocpd_sweep  # noqa: F401
            ...
            import charon.agents.stygian.loaders.composition_g11_v5_mc_gtest  # noqa: F401
            ...
            import charon.agents.stygian.loaders.composition_g19_v2_recursive_obligations  # noqa: F401
