...
**Deadline:** 2026-06-03 (Day 30; 15-day buffer for debugging interaction effects per round-6b reviewer guidance)
...
## Days 1–4 — Trial 1: Adversarial Residual Benchmark
...
- FP-quantization residuals (10)
- MC-seed jitter residuals (10)
- Gaussian residuals at noise-floor magnitude (10)
- Uniform-distribution residuals from random polynomial draws (10)
- Empty / zero residuals (10)

### Day 2 — Sample curation pass B: borderline signal (50 samples)
- Mercury perihelion residual at low-confidence regime (5)
- Ramanujan-Hardy asymptotic residuals at marginal n (5)
- Riemann Li(x)−π(x) at x where difference hardest to distinguish (5)
- F1+F6+F9+F11 calibration drift events from the 180-known-truth set (15)
- BSD-conditional residuals in the empirical-pattern domain (10)
- Modular-form coefficient mystery residuals (10)

### Day 3 — Sample curation pass C: synthetic structured-noise (100 samples)
- High-coefficient-variance residuals from random polynomial draws (30)
- Canonicalizer-subclass-matching residuals built from random hash collisions (30)
- Fake-drift fingerprints from time-correlated noise (20)
- Cyclotomic-near-miss residuals (M=1+ε for small ε) (20)
...
## Days 5–7 — Trial 1.5: Adversarial Optimization Probe
...
**Failure paths:**
- Exploit in <100 iterations → classifier structurally insufficient; revert to PROMOTE-only
- Exploit in 100-500 after retraining → architectural revision needed; hold MVP

## Days 8–17 — Trial 2: Evolutionary Engine with Bounded Buckets
...
- Implement descriptor-displacement check
...
- Cell-selection policy with coverage-pressure reweighting
...
## Days 18–22 — Trial 3: Five-Counts Diagnostic
...
## Days 23–30 — Buffer + reporting

### Days 23–27: Reserved for debugging interaction effects across trials (the round-6b reviewer's hidden time sink)

### Days 28–29: Synthesize MVP run report
...
### Day 30: Ship
- File `pivot/MVP_run_report_<date>.md` and `roles/Ergon/SESSION_JOURNAL_<date>.md`
- Begin v0.5 if MVP greenlights
...
Per v8 progression — these are NOT in the 30-day MVP:
...
- Canonical structure: `ergon/learner/README.md`
