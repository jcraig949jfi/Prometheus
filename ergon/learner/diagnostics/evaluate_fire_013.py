"""One-off evaluator for fire-013 v2 responses (decomposition_mode aware)."""
...
def main() -> int:
    probes = json.loads(Path("ergon/learner/diagnostics/fire_013_probes.json").read_text(encoding="utf-8"))
    responses_v2 = json.loads(Path("ergon/learner/diagnostics/fire_013_responses.json").read_text(encoding="utf-8"))
    ...
    Path("ergon/learner/diagnostics/fire_013_eval.json").write_text(
