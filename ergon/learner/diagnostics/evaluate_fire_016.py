"""One-off evaluator for fire-016 v2 responses (decomposition_mode aware)."""
...
def main() -> int:
    probes = json.loads(Path("ergon/learner/diagnostics/fire_016_probes.json").read_text(encoding="utf-8"))
    responses_v2 = json.loads(Path("ergon/learner/diagnostics/fire_016_responses.json").read_text(encoding="utf-8"))
    ...
    Path("ergon/learner/diagnostics/fire_016_eval.json").write_text(
