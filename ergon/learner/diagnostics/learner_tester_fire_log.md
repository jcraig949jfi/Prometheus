...
**v0.5b runner outcome:** *[FILL on background-run completion; see TIRE_KICK_v0.5_RESULT_2026-05-06.md §11 v0.5b section]*

**SELF-REVIEW:**
- (a) **Did this fix resolve the failure mode?** *[FILL after numbers land]* — eval-time masking bypasses the "model emits literal token '1'" bottleneck by construction; whether LoRA at this scale has any non-trivial signal under the masked protocol is the empirical question.
