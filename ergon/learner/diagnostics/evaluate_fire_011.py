"""One-off evaluator for fire-011 v2 responses (decomposition_mode aware)."""
...
def main() -> int:
    probes = json.loads(Path("ergon/learner/diagnostics/fire_011_probes.json").read_text(encoding="utf-8"))
    responses_v2 = json.loads(Path("ergon/learner/diagnostics/fire_011_responses.json").read_text(encoding="utf-8"))
    ...
    Path("ergon/learner/diagnostics/fire_011_eval.json").write_text(
