...
1. **C4** (stop-after-tick) and **C1** (status endpoint) — today's two operational failures were both this, and both cost a campaign more than the work would.
