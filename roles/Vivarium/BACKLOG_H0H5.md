...
| D2b | value_checker for cegis_boolean_v1, eca_rule_eval_v1, artifact_probe_v1, random_walk_v0, evaluate_bitstring: each executor's entry refusals factored into a pure `payload_problems` and named in the registry, as ca_density_v0 now is. | READY | none |
