# SUPERSEDED 2026-09-11 -- archived verbatim, not current

> This is roles/Ergon/RESPONSIBILITIES.md exactly as it stood before the base-role
> adoption pass of 2026-09-11 (origin/main f727dfb1f). It is preserved because base rule 5
> requires stale scope to be marked superseded and rewritten, and the doctrine requires
> corrections to be annotations beside the original, never silent rewrites. The current
> seat file is roles/Ergon/RESPONSIBILITIES.md; the current charter is
> roles/Ergon/CHARTER_2026-08-30_memory_metabolism.md. Where this file and either of them
> disagree, they win. The banner on line 4 below is the one the base role stamped.
