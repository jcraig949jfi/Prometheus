> HISTORICAL, SUPERSEDED 2026-09-11 (MNE-01). This is the April 2026 seat file,
> kept verbatim below the banner so nothing is silently rewritten. The live seat
> file is roles/Mnemosyne/RESPONSIBILITIES.md. Nothing below is current unless
> that file restates it: the PostgreSQL/Redis stack diagram, the three-database
> plan, the Agora integration and the "Phase 1-4" tasks describe a program that
> was replaced by the Evidence Wiki (schema ew, REST :8377) in September 2026.
> The two operator annotations of 2026-09-11 (the boundary; the stack section)
> are also preserved in place.
