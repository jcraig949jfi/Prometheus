...
CRIUS-25 | ADVANCED by the C1b GO (prompts/2026-09-19_c1b_go/): D2 = substrate/operator campaign for evolvable compositional structure; design is CRIUS-30 | ENGINE | 1.0 | M | none | crius/DESIGN_C2.md
...
CRIUS-29 | DONE: C1b run under the GO (calibration be339ac0f, gate 553ccff52, nine runs); D1 isolation answered NO; frozen C1 family CLOSED | EVIDENCE | beta | S | none | roles/Crius/REVIEW_PACKET_C1B_2026-09-19.md; crius/runs/search_c1b_*/
CRIUS-30 | DONE 565135bd0: DESIGN_C2.md preregistered before code (ladder A-D, PARTS diagnostic, paired streams + takeover, resource invariant, gates per rung, R1-R6) | ENGINE | 1.0 | M | none | crius/DESIGN_C2.md
CRIUS-32 | DONE for rungs A-B (18 runs, PARTS A-C, probes E1-E4, packet); rungs C-D gated out | EVIDENCE | 1.0 | M | none | crius/runs/C2_SUMMARY.md; roles/Crius/REVIEW_PACKET_C2_2026-09-19.md
CRIUS-33 | Rung C gate: decide (i) declared deviation (E/H with the block control, F/G with the typed control) and run C/D, (ii) stronger typed control first, (iii) stop the ladder | ENGINE | 1.0 | XL | operator decision NEW: rung C gate treatment (packet C2 s9) | the ruling recorded verbatim under prompts/ and, on (i)/(ii), crius/runs/{gate,search}_c2[cd]*/
CRIUS-34 | Add synthetic-count arms (blocks, records) to the reproducibility criterion in c2_summary/report so a counter cannot satisfy 'ACC > FRESH with competence kept' | TOOLS | 1.0 | S | none | c2_summary.py column 'content-bearing' + a test on fixture E4
CRIUS-35 | Preserve E1-E4 as fixtures with signature tests (like F1-F4) | ENGINE | 1.0 | S | none | crius/fixtures/c2_exploit_lineages.json + tests
CRIUS-31 | Integrity note from C1b: empty records and empty blocks occupy zero bytes and evade the capacity bound (bounded only by cost); decide whether to charge a minimum size | ENGINE | 1.0 | XL | operator decision NEW: minimum size for empty store objects (touches CRIUS-28) | a DECISIONS line and a test
