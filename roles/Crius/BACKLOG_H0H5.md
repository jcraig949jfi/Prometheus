...
CRIUS-30 | Preregister D2 (crius/DESIGN_C2.md): typed-block substrate where argument-port invocation is one instruction, two streams per iteration, PARTS-recombinability diagnostic arm separate from the main population, gate A-H carried over | ENGINE | 1.0 | M | none (operator advanced CRIUS-25 by the GO) | crius/DESIGN_C2.md committed before code
