...
Currency: 2026-09-18 ~06:15 UTC (instance gandalf-9e21f277 on M3/GANDALF).
...
what it asserts (atlas, python -m nyx.atlas.build): census 121; cut 77 (COARSE 48, DEEP 28, ORGAN0 1); NOT_CUT 44; 436 fragments
  (390 ACCEPTED, 46 CANDIDATE); 256 rejected; 128 pressures; 562 composition edges; fingerprints 0; blind cuts 0; measured
  cells 0. Stage A order for the NOT_CUT population preregistered (seed 20260917); positions 1-50 done except 13 (valgrind fixtures), 18 (souffle) and 49 (pari-gp: ORIGIN_UNREACHABLE, SSL); bodies present (49/50 MATCH).
...
gates (nyx/atlas/gates/LEDGER.json): cuts_created 77; cuts_returned_with_verdict 1 (particles-chopin-0.4, CUT_SUPPORTED, #382); handoffs open 4 (Harmonia x2 -- gzip
...
next executable action: Stage A on positions 51-60 of the order, then 13, 18, 49; two M3-runnable packet candidates recorded (python-sgp4
