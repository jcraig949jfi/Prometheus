...
what it asserts (atlas, python -m nyx.atlas.build): census 121; cut 68 (COARSE 45, DEEP 22, ORGAN0 1); NOT_CUT 53; 402 fragments
  (362 ACCEPTED, 40 CANDIDATE); 234 rejected; 119 pressures; 525 composition edges; fingerprints 0; blind cuts 0; measured
  cells 0. Stage A order for the NOT_CUT population preregistered (seed 20260917); positions 1-40 done except 13 (valgrind fixtures) and 18 (souffle), bodies present (40/40 MATCH).
