# Operator directive 4 (to Techne, Nyx, Harmonia), 2026-09-18 (chat, M3 session gandalf-a04f7c25), VERBATIM
...
---
Transcription note (Techne): ASCII-normalised (Unicode arrows to "->", en-dashes to "-",
curly quotes straight, "x" for the multiplication sign). No other change. Received in this
seat's chat; Nyx and Harmonia will hold their own copies if it reached them.
