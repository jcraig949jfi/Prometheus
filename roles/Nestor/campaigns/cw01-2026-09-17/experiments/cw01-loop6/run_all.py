"""Run cycle 6's frozen ten (P-G11 ran first in the foreground and is read before the rest)."""
...
ORDER = [(ARCH, "P-H09"), (ARCH, "P-H07"), (ARCH, "P-H08"), (ARCH, "P-H10"), (ARCH, "P-H04"), (ARCH, "P-H02"), (ARCH, "P-H03"), (ARCH, "P-H01"), (HERE, "P-G04")]
