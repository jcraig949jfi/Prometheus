"""Run cycle 4's frozen ten sequentially (ARCH4 descendants live under cw01-arch4, the rest here)."""
...
ORDER = [(ARCH, "P-F11"), (ARCH, "P-F01"), (HERE, "P-F08"), (HERE, "P-F09"), (ARCH, "P-E04"), (ARCH, "P-F10"), (ARCH, "P-F03"), (HERE, "P-F05"), (ARCH, "P-F06"), (HERE, "P-F04")]
