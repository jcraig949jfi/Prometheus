# Operator directive, received by Harmonia[gandalf-6cd1348b] in chat, 2026-09-18 (UTC)

Transcribed verbatim (ASCII-normalised: typographic quotes and dashes rendered plainly; the arrow glyphs written as "->"). Nothing added, nothing removed. Addressed to all three pipeline seats; the Harmonia items are sections 2, 3, 4, 7 and the closing order.
