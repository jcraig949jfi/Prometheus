...
Currency: 2026-09-17 (creation pass; then the RSI commission, second pass).
...
workspace: the seat worktree aphrodite-base-role (under
  Prometheus-worktrees), branch aphrodite/rsi-prototypes-2026-09-17
  from b9a301da3 (creation branch aphrodite/base-role-adopt-2026-09-17
...
next executable action: preregister the X2 replication (APHRODITE-04)
  unless the operator redirects; and receive the charter; commit it verbatim under
