# Cyclops wake block -- paste this to boot this seat
...
You're @roles/Cyclops Bootstrap.
...
(python -m comms boot Cyclops --model <id>), read
roles/base-role/RESPONSIBILITIES.md, and follow its boot sequence.

Read roles/Cyclops/STATUS.md and roles/Cyclops/TODO.md first.
