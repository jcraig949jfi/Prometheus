...
ANANKE-27 | Measure FLIP's distal-influence rung net of the local teacher path (zero-comm twin contrast subtracted) | EVIDENCE | beta | S | PTE-C1 A0 rows | analysis table in the A0 report
