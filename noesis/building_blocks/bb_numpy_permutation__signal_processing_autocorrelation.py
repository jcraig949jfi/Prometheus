"""
Building-block super-organism: numpy.permutation -> signal_processing.autocorrelation
...
class BbNumpyPermutationSignalProcessingAutocorrelation(MathematicalOrganism):
    name = "bb_numpy_permutation__signal_processing_autocorrelation"
    operations = {
        "chain": {
            "code": """
_bb_cache = {}
def chain(x):
    ...
    result = _bb_cache['numpy'].execute('permutation', x)
