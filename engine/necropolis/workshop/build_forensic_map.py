...
Q = [
    ...
    {"id": "FQ-07", "scope": 'RESTRICTED: literal-vocabulary vacuity only; a refusal that is an unreachable branch of a conditional is invisible to the lint (case POLLUX 2026-09-14, ADJUDICATION D9)', "question": "Was the gate vacuous?",
     "needs": "evidence the gate could and did refuse something",
     "tools": [("NT-056", "DIRECT", "literal-verdict lint: a gate that returns one verdict unconditionally (verdict vocabulary only; cannot see an unreachable refusal branch -- case POLLUX D9)"),
