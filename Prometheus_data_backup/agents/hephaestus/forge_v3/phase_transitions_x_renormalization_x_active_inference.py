"""CAITL v3 -- Phase-RG-ActiveInf v3: order-parameter detection + RG flow + epistemic foraging + general category parsers.
...
class ReasoningTool:
    """Phase-RG-ActiveInf v3: order-parameter detection + RG flow + epistemic foraging + general category parsers."""
