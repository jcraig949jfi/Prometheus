"""fractal_geometry x hebbian_learning x free_energy_principle v3.
Fractal Geometry X Hebbian Learning X Free Energy Principle.
...
class ReasoningTool:
    """Fractal Hebbian FEP Scorer v3: 15-category structural parser + fractal_hebbian_trace secondary."""
    ...
    def _theme(self, prompt, cand):
        """fractal_hebbian_trace: theme-specific secondary signal 0-1."""
