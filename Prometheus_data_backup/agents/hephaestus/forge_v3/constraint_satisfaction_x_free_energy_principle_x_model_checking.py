"""constraint_satisfaction x free_energy_principle x model_checking v3.
Constraint Satisfaction X Free Energy Principle X Model Checking.
...
class ReasoningTool:
    """CSP Free Energy Model Checker v3: 15-category structural parser + constraint_sat_ratio secondary."""
    ...
    def _theme(self, prompt, cand):
        """constraint_sat_ratio: theme-specific secondary signal 0-1."""
