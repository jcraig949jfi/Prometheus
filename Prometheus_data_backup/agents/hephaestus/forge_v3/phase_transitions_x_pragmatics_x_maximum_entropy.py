"""CAITL v3 -- Phase-Pragmatic-MaxEnt v3: criticality + pragmatic coherence + entropy maximization + general category parsers.
...
class ReasoningTool:
    """Phase-Pragmatic-MaxEnt v3: criticality + pragmatic coherence + entropy maximization + general category parsers."""
