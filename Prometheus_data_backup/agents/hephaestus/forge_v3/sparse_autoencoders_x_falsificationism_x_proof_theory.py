"""Sparse Falsification Proof v3.
Sparse Autoencoders x Falsificationism x Proof Theory.
Sparse encoding + bold conjecture + proof checking, NCD<=15%.
"""
import re, zlib, math
...
class ReasoningTool:
    """SFP v3: sparse features + falsification + proof theory + full trap coverage."""
