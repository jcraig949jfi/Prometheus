"""CAITL v3 -- RG-Feedback-FEP v3: multi-scale coarsening + PID control + free energy + general category parsers.
...
class ReasoningTool:
    """RG-Feedback-FEP v3: multi-scale coarsening + PID control + free energy + general category parsers."""
