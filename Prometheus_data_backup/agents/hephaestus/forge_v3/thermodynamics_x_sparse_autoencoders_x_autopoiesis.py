"""thermodynamics x sparse_autoencoders x autopoiesis v3.
Thermodynamics X Sparse Autoencoders X Autopoiesis.
...
class ReasoningTool:
    """Thermodynamic Autopoietic SAE v3: 15-category structural parser + homeostatic_free_energy secondary."""
    ...
    def _theme(self, prompt, cand):
        """homeostatic_free_energy: theme-specific secondary signal 0-1."""
