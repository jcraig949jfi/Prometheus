"""CAITL v3 -- Spectral-Pragmatic-Type v3: frequency-domain parsing + pragmatic scoring + type checking + general category parsers.
...
class ReasoningTool:
    """Spectral-Pragmatic-Type v3: frequency-domain parsing + pragmatic scoring + type checking + general category parsers."""
