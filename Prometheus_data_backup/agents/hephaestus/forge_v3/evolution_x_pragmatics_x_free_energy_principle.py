"""CAITL v3 -- Evolution-Pragmatic-FEP v3: fitness selection + pragmatic coherence + general category parsers.
...
class ReasoningTool:
    """Evolution-Pragmatic-FEP v3: fitness selection + pragmatic coherence + general category parsers."""
