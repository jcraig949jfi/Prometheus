"""CAITL v3 -- Functorial Chaos-SOC v3: logistic-map amplification + SOC avalanche + general category parsers.
...
class ReasoningTool:
    """Functorial Chaos-SOC v3: logistic-map amplification + SOC avalanche + general category parsers."""
