"""pragmatics x multi-armed_bandits x type_theory v3.
Pragmatics X Multi-Armed Bandits X Type Theory.
...
class ReasoningTool:
    """Pragmatic Bandit Type Resolver v3: 15-category structural parser + ucb_score secondary."""
    ...
    def _theme(self, prompt, cand):
        """ucb_score: theme-specific secondary signal 0-1."""
