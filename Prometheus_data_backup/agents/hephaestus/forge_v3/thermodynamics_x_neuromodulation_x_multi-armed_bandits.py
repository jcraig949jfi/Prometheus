"""CAITL v3 -- Thermo-Neuromod-Bandit v3: free-energy scoring + UCB exploration + general category parsers.
...
class ReasoningTool:
    """Thermo-Neuromod-Bandit v3: free-energy scoring + UCB exploration + general category parsers."""
