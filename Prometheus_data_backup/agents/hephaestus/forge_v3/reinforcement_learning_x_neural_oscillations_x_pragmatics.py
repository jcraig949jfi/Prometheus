"""reinforcement_learning x neural_oscillations x pragmatics v3.
Reinforcement Learning X Neural Oscillations X Pragmatics.
...
class ReasoningTool:
    """RL Theta-Gated Pragmatic Policy v3: 15-category structural parser + td_error secondary."""
    ...
    def _theme(self, prompt, cand):
        """td_error: theme-specific secondary signal 0-1."""
