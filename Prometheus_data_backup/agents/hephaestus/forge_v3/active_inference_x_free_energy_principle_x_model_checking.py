"""active_inference x free_energy_principle x model_checking v3.
Active Inference X Free Energy Principle X Model Checking.
...
class ReasoningTool:
    """Active Inference Model Checker v3: 15-category structural parser + prediction_error secondary."""
    ...
    def _theme(self, prompt, cand):
        """prediction_error: theme-specific secondary signal 0-1."""
