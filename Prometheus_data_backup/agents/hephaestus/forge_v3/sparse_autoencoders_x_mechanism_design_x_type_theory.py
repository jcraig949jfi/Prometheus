"""CAITL v3 -- SAE-Mech-Type v3: sparse feature extraction + mechanism design + general category parsers.
...
class ReasoningTool:
    """SAE-Mech-Type v3: sparse feature extraction + mechanism design + general category parsers."""
