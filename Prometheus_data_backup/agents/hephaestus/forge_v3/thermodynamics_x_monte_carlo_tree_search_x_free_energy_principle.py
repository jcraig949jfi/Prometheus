"""CAITL v3 -- Thermo-MCTS-FEP v3: energy landscape + tree search + free energy + general category parsers.
...
class ReasoningTool:
    """Thermo-MCTS-FEP v3: energy landscape + tree search + free energy + general category parsers."""
