"""CAITL v3 -- Optimal-Mech-ModelCheck v3: Bellman optimality + VCG incentive + general category parsers.
...
class ReasoningTool:
    """Optimal-Mech-ModelCheck v3: Bellman optimality + VCG incentive + general category parsers."""
