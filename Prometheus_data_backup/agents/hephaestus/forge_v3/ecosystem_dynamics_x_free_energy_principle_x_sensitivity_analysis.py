"""CAITL v3 -- Ecosystem-FEP-Sensitivity v3: trophic parsing + variational FE + general category parsers.
...
class ReasoningTool:
    """Ecosystem-FEP-Sensitivity v3: trophic parsing + variational FE + general category parsers."""
