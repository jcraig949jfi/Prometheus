"""CAITL v3 -- Chaos-SOC-NCD v3: logistic divergence + sandpile threshold + general category parsers.
...
class ReasoningTool:
    """Chaos-SOC-NCD v3: logistic divergence + sandpile threshold + general category parsers."""
