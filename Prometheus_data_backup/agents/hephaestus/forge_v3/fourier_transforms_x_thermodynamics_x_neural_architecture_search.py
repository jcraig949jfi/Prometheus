"""fourier_transforms x thermodynamics x neural_architecture_search v3.
Fourier Transforms X Thermodynamics X Neural Architecture Search.
...
class ReasoningTool:
    """Fourier Thermodynamic NAS Scorer v3: 15-category structural parser + spectral_energy secondary."""
    ...
    def _theme(self, prompt, cand):
        """spectral_energy: theme-specific secondary signal 0-1."""
