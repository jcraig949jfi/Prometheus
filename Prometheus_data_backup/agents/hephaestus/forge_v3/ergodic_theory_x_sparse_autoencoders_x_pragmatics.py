"""ergodic_theory x sparse_autoencoders x pragmatics v3.
Ergodic Theory X Sparse Autoencoders X Pragmatics.
...
class ReasoningTool:
    """Ergodic Sparse Pragmatic Encoder v3: 15-category structural parser + ergodic_convergence secondary."""
    ...
    def _theme(self, prompt, cand):
        """ergodic_convergence: theme-specific secondary signal 0-1."""
