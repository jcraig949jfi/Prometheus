"""ergodic_theory x abductive_reasoning x pragmatics v3.
Ergodic Theory X Abductive Reasoning X Pragmatics.
...
class ReasoningTool:
    """Ergodic Abductive Pragmatic Sampler v3: 15-category structural parser + ergodic_overlap secondary."""
    ...
    def _theme(self, prompt, cand):
        """ergodic_overlap: theme-specific secondary signal 0-1."""
