"""sparse_autoencoders x spectral_analysis x model_checking v3.
Sparse Autoencoders X Spectral Analysis X Model Checking.
...
class ReasoningTool:
    """Sparse Spectral Model Checker v3: 15-category structural parser + spectral_sparsity secondary."""
    ...
    def _theme(self, prompt, cand):
        """spectral_sparsity: theme-specific secondary signal 0-1."""
