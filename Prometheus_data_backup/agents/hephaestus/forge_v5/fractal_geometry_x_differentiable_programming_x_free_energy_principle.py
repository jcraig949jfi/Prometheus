"""CAITL v5 (metacognition-enhanced) Fractal-FEP Differentiable Reasoner: multi-scale constraint + sigmoid gradients. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Fractal-FEP Differentiable Reasoner: multi-scale constraint + sigmoid gradients v4."""
    TAG="FGDP"
