"""CAITL v5 (metacognition-enhanced) Phase GRN Mechanism: bistable switch + incentive regulation. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Phase GRN Mechanism: bistable switch + incentive regulation v4."""
    TAG="PGRM"
