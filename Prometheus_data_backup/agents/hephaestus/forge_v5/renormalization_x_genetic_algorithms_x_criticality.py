"""CAITL v5 (metacognition-enhanced) — Renormalisation-Genetic Criticality Engine. Multi-scale RG flow with
genetic selection + critical-point stability scoring.
...
class ReasoningTool:
    """Renormalisation-Genetic Criticality Engine v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="RGCE-v4"
