"""CAITL v5 (metacognition-enhanced) — Reservoir Predictive-Spectral Reasoner. Structural feature scoring +
spectral mode analysis + precision-weighted prediction error.
...
class ReasoningTool:
    """Reservoir Predictive-Spectral Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="RPSR-v4"
