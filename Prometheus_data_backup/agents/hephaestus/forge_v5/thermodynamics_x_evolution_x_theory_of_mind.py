"""CAITL v5 (metacognition-enhanced) — Thermo-Evolutionary ToM Engine. Free-energy belief scoring + evolutionary
fitness selection + theory-of-mind perspective tracking.
...
class ReasoningTool:
    """Thermo-Evolutionary ToM Engine v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="TETM-v4"
