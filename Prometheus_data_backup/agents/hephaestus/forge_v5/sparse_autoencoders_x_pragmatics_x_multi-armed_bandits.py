"""CAITL v5 (metacognition-enhanced) — Sparse Pragmatic Bandit. SAE-style sparse feature extraction + Gricean
utility scoring + bandit arm selection.
...
class ReasoningTool:
    """Sparse Pragmatic Bandit v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="SPB-v4"
