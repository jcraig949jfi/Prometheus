"""v5 (metacognition-enhanced) Ecosystem bandit Lotka-Volterra FEP — 58-category constructive computation.
Secondary: Ecosystem bandit Lotka-Volterra FEP. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._cc=100
    def _ncd(self,a,b):
