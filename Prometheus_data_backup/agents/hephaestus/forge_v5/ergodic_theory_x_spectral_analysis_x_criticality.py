"""CAITL v5 (metacognition-enhanced) Ergodic Spectral Critical: eigenvalue-gap + critical amplification. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Ergodic Spectral Critical: eigenvalue-gap + critical amplification v4."""
    TAG="ESAC"
