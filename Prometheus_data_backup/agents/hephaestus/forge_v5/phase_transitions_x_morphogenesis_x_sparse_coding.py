"""v5 (metacognition-enhanced) Phase-morphogenetic sparse code — 58-category constructive computation.
Secondary: Phase-morphogenetic sparse code. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._th=0.5
    def _ncd(self,a,b):
