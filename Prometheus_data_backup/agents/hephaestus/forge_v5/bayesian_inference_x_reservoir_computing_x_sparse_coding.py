"""CAITL v5 (metacognition-enhanced) Bayesian Reservoir Sparse: echo-state projection + sparse posterior. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Bayesian Reservoir Sparse: echo-state projection + sparse posterior v4."""
    TAG="BRSC"
