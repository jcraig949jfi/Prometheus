"""CAITL v5 (metacognition-enhanced) — Error-Correcting Nash Free-Energy Reasoner. LDPC parity checks +
Nash strategic stability + free-energy minimisation.
...
class ReasoningTool:
    """Error-Correcting Nash Free-Energy Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="ECNR-v4"
