"""CAITL v5 (metacognition-enhanced) — Thermo-Optimal Pragmatic Controller. Hamilton-Jacobi-Bellman cost
functional + Gricean pragmatic shaping + entropy regularisation.
...
class ReasoningTool:
    """Thermo-Optimal Pragmatic Controller v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="TOPC-v4"
