"""CAITL v5 (metacognition-enhanced) — Phase-Transition Kolmogorov FE Scorer. Critical-point detection via
complexity thresholds + minimum-description-length ranking.
...
class ReasoningTool:
    """Phase-Transition Kolmogorov FE Scorer v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="PTKFE-v4"
