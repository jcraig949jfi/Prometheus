"""CAITL v5 (metacognition-enhanced) — Sparse Adaptive Pragmatic Controller. Sparse structural coding +
adaptive-gain control + Gricean pragmatic cost shaping.
...
class ReasoningTool:
    """Sparse Adaptive Pragmatic Controller v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="SAPC-v4"
