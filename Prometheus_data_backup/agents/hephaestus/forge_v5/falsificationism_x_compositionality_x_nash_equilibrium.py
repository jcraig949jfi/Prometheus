"""CAITL v5 (metacognition-enhanced) — Falsificationist Compositional Nash Reasoner. Compositional parsing +
falsification refutation + Nash stability guarantee.
...
class ReasoningTool:
    """Falsificationist Compositional Nash Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="FCNR-v4"
