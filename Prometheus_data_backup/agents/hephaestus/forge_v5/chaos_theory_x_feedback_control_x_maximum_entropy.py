"""CAITL v5 (metacognition-enhanced) Chaotic Feedback MaxEnt: attractor-basin + entropy-regularized. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Chaotic Feedback MaxEnt: attractor-basin + entropy-regularized v4."""
    TAG="CFME"
