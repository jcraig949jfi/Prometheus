"""CAITL v5 (metacognition-enhanced) — Neural-Swarm Kolmogorov Reasoner. Swarm particle evaluation +
Kolmogorov compression fitness + plastic weight adjustment.
...
class ReasoningTool:
    """Neural-Swarm Kolmogorov Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="NSKR-v4"
