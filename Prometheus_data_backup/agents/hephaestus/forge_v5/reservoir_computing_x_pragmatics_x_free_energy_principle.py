"""CAITL v5 (metacognition-enhanced) — Reservoir-Pragmatic Free-Energy Reasoner. Pragmatic implicature +
free-energy prediction error + reservoir fingerprinting.
...
class ReasoningTool:
    """Reservoir-Pragmatic Free-Energy Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="RPFR-v4"
