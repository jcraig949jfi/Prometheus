"""CAITL v5 (metacognition-enhanced) — Categorical Information Criticality. Functorial channel capacity +
mutual-information scoring + critical-point detection.
...
class ReasoningTool:
    """Categorical Information Criticality v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="CICT-v4"
