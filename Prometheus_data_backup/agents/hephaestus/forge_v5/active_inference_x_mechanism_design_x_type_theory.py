"""v5 (metacognition-enhanced) DT-AIM dependent-type active inference — 58-category constructive computation.
Secondary: DT-AIM dependent-type active inference. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
