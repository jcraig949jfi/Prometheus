"""v5 (metacognition-enhanced) Oscillatory Bayesian gamma-band FEP — 58-category constructive computation.
Secondary: Oscillatory Bayesian gamma-band FEP. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._f=40.0
    def _ncd(self,a,b):
