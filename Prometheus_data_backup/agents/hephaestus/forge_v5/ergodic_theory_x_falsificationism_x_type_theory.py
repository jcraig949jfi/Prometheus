"""CAITL v5 (metacognition-enhanced) — Ergodic Falsificationist Type Reasoner. Type constraints +
falsification via structural contradiction + ergodic averaging.
...
class ReasoningTool:
    """Ergodic Falsificationist Type Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="EFTR-v4"
