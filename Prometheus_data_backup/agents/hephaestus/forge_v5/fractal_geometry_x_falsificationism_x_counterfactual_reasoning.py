"""CAITL v5 (metacognition-enhanced) — Fractal Falsificationist Counterfactual Reasoner. Multi-scale
falsification + counterfactual premise inversion.
...
class ReasoningTool:
    """Fractal Falsificationist Counterfactual Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="FFCR-v4"
