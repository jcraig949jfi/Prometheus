"""v5 (metacognition-enhanced) Embodied network thermodynamics — 58-category constructive computation.
Secondary: Embodied network thermodynamics. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._dp=0.1
    def _ncd(self,a,b):
