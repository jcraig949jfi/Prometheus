"""CAITL v5 (metacognition-enhanced) — Ergodic Theory-of-Mind Abductive Reasoner. Mental-state attribution +
abductive explanation + ergodic weight averaging.
...
class ReasoningTool:
    """Ergodic Theory-of-Mind Abductive Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="ETAR-v4"
