"""v5 (metacognition-enhanced) Ergodic dual-process measure — 58-category constructive computation.
Secondary: Ergodic dual-process measure. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
