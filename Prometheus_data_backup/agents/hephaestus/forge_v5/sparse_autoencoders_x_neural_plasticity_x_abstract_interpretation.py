"""CAITL v5 (metacognition-enhanced) Sparse Plastic Abstract: bottleneck + Galois constraint checking. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Sparse Plastic Abstract: bottleneck + Galois constraint checking v4."""
    TAG="SNAI"
