"""CAITL v5 (metacognition-enhanced) — Swarm Metacognitive Mechanism. Particle-swarm consensus + metacognitive
confidence monitoring + mechanism-design ranking.
...
class ReasoningTool:
    """Swarm Metacognitive Mechanism v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="SMMR-v4"
