"""CAITL v5 (metacognition-enhanced) Chaotic SOC NCD: sandpile sensitivity + compression tiebreak. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Chaotic SOC NCD: sandpile sensitivity + compression tiebreak v4."""
    TAG="CSCN"
