"""CAITL v5 (metacognition-enhanced) — Statistical Predictive Abductive Reasoner. Partition function scoring +
prediction error + abductive best-explanation selection.
...
class ReasoningTool:
    """Statistical Predictive Abductive Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="SPAR-v4"
