"""CAITL v5 (metacognition-enhanced) Info Sparse Bandit: compression UCB + sparse activation. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Info Sparse Bandit: compression UCB + sparse activation v4."""
    TAG="ISMB"
