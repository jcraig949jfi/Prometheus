"""CAITL v5 (metacognition-enhanced) — Global Workspace Mechanism Model-Checker. Broadcast consensus scoring +
mechanism-design ranking + temporal-logic verification.
...
class ReasoningTool:
    """Global Workspace Mechanism Model-Checker v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="GWMC-v4"
