"""CAITL v5 (metacognition-enhanced) Ergodic FEP MaxEnt: Birkhoff-average + Jaynes entropy. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Ergodic FEP MaxEnt: Birkhoff-average + Jaynes entropy v4."""
    TAG="EFME"
