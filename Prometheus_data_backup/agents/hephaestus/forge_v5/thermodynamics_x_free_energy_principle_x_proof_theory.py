"""CAITL v5 (metacognition-enhanced) — Thermodynamic Proof-Theoretic Free-Energy Reasoner (TPFER).
...
class ReasoningTool:
    """Thermodynamic Proof-Theoretic Free-Energy Reasoner v4. struct>=52% comp>=23% ncd<=10%."""
    TAG="TPFER-v4"
