"""v5 (metacognition-enhanced) Bayesian sensitivity perturbation — 58-category constructive computation.
Secondary: Bayesian sensitivity perturbation. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._eps=0.01
    def _ncd(self,a,b):
