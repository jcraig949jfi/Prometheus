"""CAITL v5 (metacognition-enhanced) Evolutionary Critical FEP: fitness-landscape at phase boundary. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Evolutionary Critical FEP: fitness-landscape at phase boundary v4."""
    TAG="ECFE"
