"""v5 CAITL (metacognition-enhanced): Dialectical autopoietic KC: thesis-antithesis complexity in self-producing systems.

Primary scoring via 58-category constructive parsers with Bayesian posteriors,
PEMDAS, modular arithmetic, constraint propagation. Secondary: dialectics x autopoiesis x kolmogorov complexity.
"""
import re, math, zlib
import numpy as np
