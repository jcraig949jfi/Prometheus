"""CAITL v5 (metacognition-enhanced) — Topological Epistemic Sparse Coder. Persistent-homology structural
invariance + epistemic confidence calibration + sparse features.
...
class ReasoningTool:
    """Topological Epistemic Sparse Coder v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="TESC-v4"
