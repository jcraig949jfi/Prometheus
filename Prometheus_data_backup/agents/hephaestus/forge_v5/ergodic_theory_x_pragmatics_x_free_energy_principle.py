"""CAITL v5 (metacognition-enhanced) Ergodic Pragmatic FEP: implicature + mixing-time convergence. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Ergodic Pragmatic FEP: implicature + mixing-time convergence v4."""
    TAG="EPFE"
