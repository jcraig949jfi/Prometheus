"""v5 CAITL (metacognition-enhanced): Phase-transition GA FEP: evolutionary fitness at critical transitions.

Primary scoring via 58-category constructive parsers with Bayesian posteriors,
PEMDAS, modular arithmetic, constraint propagation. Secondary: phase transitions x genetic algorithms x free energy principle.
"""
import re, math, zlib
import numpy as np
