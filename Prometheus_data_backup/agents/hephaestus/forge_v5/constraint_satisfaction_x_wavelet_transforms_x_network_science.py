"""CAITL v5 (metacognition-enhanced) — Constraint-Wavelet Network Reasoner. CSP satisfaction +
network constraint propagation + wavelet confidence.
...
class ReasoningTool:
    """Constraint-Wavelet Network Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="CWNR-v4"
