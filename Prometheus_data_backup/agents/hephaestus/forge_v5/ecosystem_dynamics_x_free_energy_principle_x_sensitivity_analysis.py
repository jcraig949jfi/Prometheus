"""CAITL v5 (metacognition-enhanced) Ecosystem FEP Sensitivity: Lotka-Volterra + Sobol scoring. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Ecosystem FEP Sensitivity: Lotka-Volterra + Sobol scoring v4."""
    TAG="EDFS"
