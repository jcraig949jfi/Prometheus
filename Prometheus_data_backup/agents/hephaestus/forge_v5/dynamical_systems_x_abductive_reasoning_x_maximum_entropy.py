"""CAITL v5 (metacognition-enhanced) Dynamical Abductive MaxEnt: phase-portrait hypothesis + entropy. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Dynamical Abductive MaxEnt: phase-portrait hypothesis + entropy v4."""
    TAG="DAME"
