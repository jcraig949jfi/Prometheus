"""CAITL v5 (metacognition-enhanced) — Gene-Regulatory Neuromodulated Reasoner. Regulatory network topology
from structural constraints + neuromodulatory gain.
...
class ReasoningTool:
    """Gene-Regulatory Neuromodulated Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="GRNR-v4"
