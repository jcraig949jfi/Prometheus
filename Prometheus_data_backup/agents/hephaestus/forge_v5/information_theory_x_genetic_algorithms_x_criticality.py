"""v5 CAITL (metacognition-enhanced): Info-theoretic GA criticality: mutual information fitness at phase boundaries.

Primary scoring via 58-category constructive parsers with Bayesian posteriors,
PEMDAS, modular arithmetic, constraint propagation. Secondary: information theory x genetic algorithms x criticality.
"""
import re, math, zlib
import numpy as np
