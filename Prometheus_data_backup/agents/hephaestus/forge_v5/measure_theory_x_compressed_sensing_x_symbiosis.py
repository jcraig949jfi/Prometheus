"""CAITL v5 (metacognition-enhanced) — Symbiotic Measure-Compressed Reasoner. Sigma-algebra constraints +
sparse signal residual + symbiotic ensemble aggregation.
...
class ReasoningTool:
    """Symbiotic Measure-Compressed Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="SMCR-v4"
