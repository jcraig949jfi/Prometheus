"""v5 CAITL (metacognition-enhanced): RG active-inference neuromod: coarse-grained belief update with gain control.

Primary scoring via 58-category constructive parsers with Bayesian posteriors,
PEMDAS, modular arithmetic, constraint propagation. Secondary: renormalization x active inference x neuromodulation.
"""
import re, math, zlib
import numpy as np
