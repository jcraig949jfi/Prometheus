"""CAITL v5 (metacognition-enhanced) — Chaotic Cognitive-Kalman Reasoner. Kalman belief update +
cognitive load threshold adjustment + chaos sensitivity.
...
class ReasoningTool:
    """Chaotic Cognitive-Kalman Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="CCKR-v4"
