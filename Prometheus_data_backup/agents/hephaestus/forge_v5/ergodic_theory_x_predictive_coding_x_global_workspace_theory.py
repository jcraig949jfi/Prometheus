"""CAITL v5 (metacognition-enhanced) Ergodic Predictive GWT: mixing prediction-error + broadcast. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Ergodic Predictive GWT: mixing prediction-error + broadcast v4."""
    TAG="EPGW"
