"""CAITL v5 (metacognition-enhanced) — SAE-Falsification-FEP. Constructive computation, 58-cat parsers,
...
def _struct(p, c):
    ...
    wt = [0.22, 0.19, 0.14, 0.12, 0.12, 0.10, 0.11]
...
def _theory(prompt, cand):
    """Theory-specific: sparse encoding + falsification filter."""
...
class ReasoningTool:
    """v4 SAFF: constructive computation, epistemic honesty, 58-cat parsers,
    ...
    def evaluate(self, prompt: str, candidates: List[str]) -> List[Dict[str, Any]]:
        ...
        for i, cand in enumerate(candidates):
            ...
            reason = f"[SAFF-v4] {sr} | {cr} | ncd={ncd_raw[i]:.3f}"
