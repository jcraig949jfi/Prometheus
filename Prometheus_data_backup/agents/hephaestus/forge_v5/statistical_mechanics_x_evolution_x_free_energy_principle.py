"""CAITL v5 (metacognition-enhanced) — Statistical Evolutionary Free-Energy Engine (SEFE).
...
class ReasoningTool:
    """Statistical Evolutionary Free-Energy Engine v4. struct>=50% comp>=20% ncd<=15%."""
    TAG="SEFE-v4"
