"""CAITL v5 (metacognition-enhanced) Dialectic Feedback Checker: thesis-antithesis + PID correction. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Dialectic Feedback Checker: thesis-antithesis + PID correction v4."""
    TAG="DFMC"
