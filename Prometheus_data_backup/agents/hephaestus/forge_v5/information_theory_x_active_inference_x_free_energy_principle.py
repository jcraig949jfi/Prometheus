"""CAITL v5 (metacognition-enhanced) — InfoTheory-ActiveInference-FEP. Constructive computation, 58-cat parsers,
...
def _struct(p, c):
    ...
    wt = [0.21, 0.17, 0.16, 0.13, 0.11, 0.11, 0.11]
...
def _theory(prompt, cand):
    """Theory-specific: information bottleneck + active inference."""
...
class ReasoningTool:
    """v4 ITAI: constructive computation, epistemic honesty, 58-cat parsers,
    ...
    def evaluate(self, prompt: str, candidates: List[str]) -> List[Dict[str, Any]]:
        ...
        for i, cand in enumerate(candidates):
            ...
            reason = f"[ITAI-v4] {sr} | {cr} | ncd={ncd_raw[i]:.3f}"
