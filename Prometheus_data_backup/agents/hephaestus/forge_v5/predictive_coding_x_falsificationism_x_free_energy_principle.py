"""v5 (metacognition-enhanced) Predictive falsification FEP — 58-category constructive computation.
Secondary: Predictive falsification FEP. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._pr=1.0
    def _ncd(self,a,b):
