"""CAITL v5 (metacognition-enhanced) Info Spectral Oscillator: spectral entropy + phase-locked. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Info Spectral Oscillator: spectral entropy + phase-locked v4."""
    TAG="ISSO"
