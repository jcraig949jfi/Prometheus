"""CAITL v5 (metacognition-enhanced) — Chaotic Predictive Maximum-Entropy Reasoner. MaxEnt distribution +
predictive coding errors + chaos sensitivity analysis.
...
class ReasoningTool:
    """Chaotic Predictive Maximum-Entropy Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="CPMR-v4"
