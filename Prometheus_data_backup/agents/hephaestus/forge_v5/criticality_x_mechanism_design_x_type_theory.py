"""v5 CAITL (metacognition-enhanced): Critical mechanism types: edge-of-chaos incentive design with type safety.

Primary scoring via 58-category constructive parsers with Bayesian posteriors,
PEMDAS, modular arithmetic, constraint propagation. Secondary: criticality x mechanism design x type theory.
"""
import re, math, zlib
import numpy as np
