"""v5 CAITL (metacognition-enhanced): Ergodic immune differentiable: gradient-based self/non-self discrimination.

Primary scoring via 58-category constructive parsers with Bayesian posteriors,
PEMDAS, modular arithmetic, constraint propagation. Secondary: ergodic theory x differentiable programming x immune systems.
"""
import re, math, zlib
import numpy as np
