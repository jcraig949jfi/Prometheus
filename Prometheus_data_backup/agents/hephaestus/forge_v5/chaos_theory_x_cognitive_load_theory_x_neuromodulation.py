"""CAITL v5 (metacognition-enhanced) Chaotic CogLoad Neuromod: complexity budget + modulatory gain. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Chaotic CogLoad Neuromod: complexity budget + modulatory gain v4."""
    TAG="CCLN"
