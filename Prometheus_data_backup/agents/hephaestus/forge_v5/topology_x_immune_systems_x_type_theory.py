"""CAITL v5 (metacognition-enhanced) — Topological Immune Type-Checker. Persistent-homology feature extraction +
immune discrimination + dependent-type verification.
...
class ReasoningTool:
    """Topological Immune Type-Checker v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="TITC-v4"
