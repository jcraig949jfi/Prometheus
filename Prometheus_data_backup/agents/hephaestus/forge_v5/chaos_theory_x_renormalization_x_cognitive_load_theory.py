"""CAITL v5 (metacognition-enhanced) Chaotic Renorm CogLoad: multi-scale complexity budget. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Chaotic Renorm CogLoad: multi-scale complexity budget v4."""
    TAG="CRCL"
