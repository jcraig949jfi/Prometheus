"""CAITL v5 (metacognition-enhanced) Quantum Critical Typer: superposition + critical type check. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Quantum Critical Typer: superposition + critical type check v4."""
    TAG="QMCT"
