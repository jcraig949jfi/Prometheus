"""CAITL v5 (metacognition-enhanced) Epistemic Feedback MaxEnt: justified-belief + PID + entropy. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Epistemic Feedback MaxEnt: justified-belief + PID + entropy v4."""
    TAG="EFCM"
