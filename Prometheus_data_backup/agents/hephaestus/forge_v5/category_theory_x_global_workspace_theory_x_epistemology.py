"""CAITL v5 (metacognition-enhanced) — Categorical Global-Workspace Epistemic Reasoner. Global broadcast +
compositional consistency + epistemic justification.
...
class ReasoningTool:
    """Categorical Global-Workspace Epistemic Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="CGWE-v4"
