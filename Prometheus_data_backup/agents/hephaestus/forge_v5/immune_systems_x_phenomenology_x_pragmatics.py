"""CAITL v5 (metacognition-enhanced) — Clonal-Phenomenological Bracketed Reasoner. Clonal selection on
phenomenologically bracketed tokens + pragmatic implicature.
...
class ReasoningTool:
    """Clonal-Phenomenological Bracketed Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="CPBR-v4"
