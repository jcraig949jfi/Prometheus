"""CAITL v5 (metacognition-enhanced) — Neuromodulated Critical Phase Reasoner. Edge-of-criticality gain
control + structural signal variance detection.
...
class ReasoningTool:
    """Neuromodulated Critical Phase Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="NCPR-v4"
