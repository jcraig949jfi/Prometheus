"""CAITL v5 (metacognition-enhanced) Ergodic Mechanism Bandit: time-average VCG + UCB. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Ergodic Mechanism Bandit: time-average VCG + UCB v4."""
    TAG="EMDB"
