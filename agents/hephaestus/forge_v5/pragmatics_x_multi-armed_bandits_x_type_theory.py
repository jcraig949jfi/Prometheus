"""CAITL v5 (metacognition-enhanced) — Pragmatic Bandit Type-Checker. Gricean utility + Thompson sampling
arm selection + dependent-type structural verification.
...
class ReasoningTool:
    """Pragmatic Bandit Type-Checker v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="PBTC-v4"
