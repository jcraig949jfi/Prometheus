"""CAITL v5 (metacognition-enhanced) Tensor Morphogenic Compositor: reaction-diffusion error + rank-adaptive scoring. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Tensor Morphogenic Compositor: reaction-diffusion error + rank-adaptive scoring v4."""
    TAG="TDMC"
    def evaluate(self,prompt:str,candidates:List[str])->List[Dict]:
        ...
        for c in candidates:
            ...
            f=0.5*st+0.25*cs+0.12*nc+0.13*lr
