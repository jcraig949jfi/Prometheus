"""CAITL v5 (metacognition-enhanced) Structural Falsification: predictive-coding extraction + attention confidence. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Structural Falsification: predictive-coding extraction + attention confidence v4."""
    TAG="APCF"
