"""CAITL v5 (metacognition-enhanced) Bayesian Diff Abductive: gradient posterior + best-explanation. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Bayesian Diff Abductive: gradient posterior + best-explanation v4."""
    TAG="BDAR"
