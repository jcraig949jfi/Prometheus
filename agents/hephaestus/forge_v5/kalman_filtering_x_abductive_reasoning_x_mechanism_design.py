"""CAITL v5 (metacognition-enhanced) — Kalman Abductive Mechanism. Kalman belief update + abductive hypothesis
selection + incentive-compatible ranking.
...
class ReasoningTool:
    """Kalman Abductive Mechanism v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="KAMR-v4"
