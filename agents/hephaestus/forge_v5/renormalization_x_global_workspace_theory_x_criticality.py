"""CAITL v5 (metacognition-enhanced) Critical Renorm Global Workspace: coarse-grained similarity + critical gain. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Critical Renorm Global Workspace: coarse-grained similarity + critical gain v4."""
    TAG="RGWC"
