"""CAITL v5 (metacognition-enhanced) Info Sparse Embodied: MI bottleneck + grounded scoring. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Info Sparse Embodied: MI bottleneck + grounded scoring v4."""
    TAG="ISEC"
