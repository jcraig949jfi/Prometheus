"""CAITL v5 (metacognition-enhanced) — Spectral Emergence Feedback Controller. Eigenvalue gap detection for
emergent structure + PID-style error correction.
...
class ReasoningTool:
    """Spectral Emergence Feedback Controller v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="SEFC-v4"
