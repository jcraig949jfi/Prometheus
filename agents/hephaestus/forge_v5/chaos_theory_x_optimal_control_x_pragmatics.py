"""CAITL v5 (metacognition-enhanced) — Chaotic Optimal Pragmatic Controller. Logistic-map deterministic probing +
HJB cost functional + Gricean pragmatic cost shaping.
...
class ReasoningTool:
    """Chaotic Optimal Pragmatic Controller v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="COPC-v4"
