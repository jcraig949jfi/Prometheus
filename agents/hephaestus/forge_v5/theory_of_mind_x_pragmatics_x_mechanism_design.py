"""v5 CAITL (metacognition-enhanced): ToM pragmatic mechanisms: belief attribution under strategic communication.

Primary scoring via 58-category constructive parsers with Bayesian posteriors,
PEMDAS, modular arithmetic, constraint propagation. Secondary: theory of mind x pragmatics x mechanism design.
"""
import re, math, zlib
import numpy as np
