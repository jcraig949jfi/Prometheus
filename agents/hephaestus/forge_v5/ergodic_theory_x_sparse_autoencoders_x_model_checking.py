"""CAITL v5 (metacognition-enhanced) — Ergodic SAE Model-Checker. Ergodic coverage sampling + sparse-autoencoder
feature extraction + temporal-logic model checking.
...
class ReasoningTool:
    """Ergodic SAE Model-Checker v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="ESMC-v4"
