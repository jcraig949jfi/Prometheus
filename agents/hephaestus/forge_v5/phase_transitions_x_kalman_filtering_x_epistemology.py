"""CAITL v5 (metacognition-enhanced) — Phase-Transition Kalman Epistemics. Critical-threshold detection +
Kalman belief update + epistemic confidence calibration.
...
class ReasoningTool:
    """Phase-Transition Kalman Epistemics v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="PTKE-v4"
