"""CAITL v5 (metacognition-enhanced) Fractal Falsification Controller: IFS constraint + PID. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Fractal Falsification Controller: IFS constraint + PID v4."""
    TAG="FFFC"
