"""CAITL v5 (metacognition-enhanced) — Plastic Hebbian MaxEnt Scorer. Synaptic-weight structural matching +
maximum-entropy regularised confidence gating.
...
class ReasoningTool:
    """Plastic Hebbian MaxEnt Scorer v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="PHME-v4"
