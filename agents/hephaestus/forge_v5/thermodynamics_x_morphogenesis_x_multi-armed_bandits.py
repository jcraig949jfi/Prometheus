"""v5 (metacognition-enhanced) Thermodynamic Morphogenetic Bandit — 58-category constructive computation.
Secondary: entropy-production UCB with reaction-diffusion morphogenesis.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._b=0.15
    def _ncd(self,a,b):
    ...
    def _cs(self,p,c):
        ...
        return 0.,"F"
    def _sec(self,p,c): return len(set(c))/(len(c)+1)*self._b
