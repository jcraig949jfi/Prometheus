"""CAITL v5 (metacognition-enhanced) — Falsificationist Neuromodulated Mechanism. Popperian falsification checks
+ neuromodulatory confidence gating + incentive-compatible ranking.
...
class ReasoningTool:
    """Falsificationist Neuromodulated Mechanism v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="FNM-v4"
