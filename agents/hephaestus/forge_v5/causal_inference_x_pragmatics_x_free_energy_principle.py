"""v5 CAITL (metacognition-enhanced): Causal-pragmatic FEP: do-calculus meets conversational implicature.

Primary scoring via 58-category constructive parsers with Bayesian posteriors,
PEMDAS, modular arithmetic, constraint propagation. Secondary: causal inference x pragmatics x free energy principle.
"""
import re, math, zlib
import numpy as np
