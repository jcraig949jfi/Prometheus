"""CAITL v5 (metacognition-enhanced) Bayesian Constraint Satisfier: posterior + arc-consistency under FEP. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Bayesian Constraint Satisfier: posterior + arc-consistency under FEP v4."""
    TAG="BCSF"
