"""CAITL v5 (metacognition-enhanced) — Morphogenetic Neuromodulated Mechanism Reasoner. Pattern-formation
constraint propagation + gain control + incentive compatibility.
...
class ReasoningTool:
    """Morphogenetic Neuromodulated Mechanism Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="MNMR-v4"
