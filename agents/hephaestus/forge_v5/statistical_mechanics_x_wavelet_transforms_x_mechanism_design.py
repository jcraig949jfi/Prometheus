"""CAITL v5 (metacognition-enhanced) — Wavelet Mechanism-Design Reasoner. VCG ensemble scoring + wavelet
variance noise detection + structural logic core.
...
class ReasoningTool:
    """Wavelet Mechanism-Design Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="WMDR-v4"
