"""CAITL v5 (metacognition-enhanced) — Spectral-Entropy-Guided NAS. Frequency-domain structural parsing +
thermodynamic regularity + architecture-search scoring.
...
class ReasoningTool:
    """Spectral-Entropy-Guided NAS v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="SEGN-v4"
