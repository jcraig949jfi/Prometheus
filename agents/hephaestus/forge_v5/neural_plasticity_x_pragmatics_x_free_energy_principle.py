"""v5 (metacognition-enhanced) Hebbian pragmatic FEP — 58-category constructive computation.
Secondary: Hebbian pragmatic FEP. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._lr=0.1
    def _ncd(self,a,b):
