"""CAITL v5 (metacognition-enhanced) ToM Mechanism Sensitivity: belief VCG + Sobol robustness. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """ToM Mechanism Sensitivity: belief VCG + Sobol robustness v4."""
    TAG="TMSA"
