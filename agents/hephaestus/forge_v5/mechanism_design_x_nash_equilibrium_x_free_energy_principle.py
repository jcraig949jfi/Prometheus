"""v5 (metacognition-enhanced) VCG-Nash Free Energy — 58-category constructive computation.
Secondary: VCG-Nash Free Energy. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._cc=0.01
    def _ncd(self,a,b):
