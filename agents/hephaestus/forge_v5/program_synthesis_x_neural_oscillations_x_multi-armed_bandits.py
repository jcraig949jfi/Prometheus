"""CAITL v5 (metacognition-enhanced) — Bandit-Oscillatory Program Synthesiser. Theta exploration +
gamma exploitation + constraint-predicate synthesis.
...
class ReasoningTool:
    """Bandit-Oscillatory Program Synthesiser v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="BOPS-v4"
