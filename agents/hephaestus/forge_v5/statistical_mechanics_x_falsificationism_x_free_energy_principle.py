"""CAITL v5 (metacognition-enhanced) — Statistical-Falsificationist Free-Energy Reasoner. Partition function +
falsification penalties + free-energy hypothesis selection.
...
class ReasoningTool:
    """Statistical-Falsificationist Free-Energy Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="SFFR-v4"
