"""CAITL v5 (metacognition-enhanced) — Epigenetic Bandit Type-Director. Methylation-analogue feature gating +
Thompson sampling selection + dependent-type verification.
...
class ReasoningTool:
    """Epigenetic Bandit Type-Director v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="EBTD-v4"
