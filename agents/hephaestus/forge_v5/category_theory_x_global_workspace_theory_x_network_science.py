"""CAITL v5 (metacognition-enhanced) — Categorical Global Workspace Network. Functorial feature mapping +
workspace broadcast consensus + network message-passing.
...
class ReasoningTool:
    """Categorical Global Workspace Network v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="CGWN-v4"
