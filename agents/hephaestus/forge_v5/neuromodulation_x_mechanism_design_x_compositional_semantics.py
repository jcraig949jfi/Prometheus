"""CAITL v5 (metacognition-enhanced) — Neuromodulated Mechanism-Compositional Reasoner. Compositional
predicate decomposition + mechanism ranking + gain control.
...
class ReasoningTool:
    """Neuromodulated Mechanism-Compositional Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="NMCR-v4"
