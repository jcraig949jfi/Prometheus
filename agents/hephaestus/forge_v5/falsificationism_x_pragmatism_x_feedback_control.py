"""CAITL v5 (metacognition-enhanced) — Falsification-Pragmatist Feedback Controller. Popperian bold
conjecture testing + pragmatic utility + PID gain control.
...
class ReasoningTool:
    """Falsification-Pragmatist Feedback Controller v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="FPFC-v4"
