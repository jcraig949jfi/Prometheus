"""v5 (metacognition-enhanced) Hoare network pragmatic Floyd-Warshall — 58-category constructive computation.
Secondary: Hoare network pragmatic Floyd-Warshall. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._cw={'because':0.9,'therefore':0.8,'if':0.7}
    def _ncd(self,a,b):
