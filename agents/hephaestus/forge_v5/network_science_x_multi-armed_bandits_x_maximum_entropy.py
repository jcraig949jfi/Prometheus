"""CAITL v5 (metacognition-enhanced) Network Bandit MaxEnt: centrality UCB + entropy reg. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Network Bandit MaxEnt: centrality UCB + entropy reg v4."""
    TAG="NMME"
