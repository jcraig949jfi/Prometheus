"""CAITL v5 (metacognition-enhanced) Phase Critical Checker: order-parameter + critical verification. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Phase Critical Checker: order-parameter + critical verification v4."""
    TAG="PCMC"
