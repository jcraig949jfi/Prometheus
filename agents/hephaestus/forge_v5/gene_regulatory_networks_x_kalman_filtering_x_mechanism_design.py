"""CAITL v5 (metacognition-enhanced) — Gene-Kalman Mechanism Reasoner. Regulatory network logic +
Kalman belief update + incentive-compatible ranking.
...
class ReasoningTool:
    """Gene-Kalman Mechanism Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="GKMR-v4"
