"""v5 (metacognition-enhanced) Chaotic wavelet compositional — 58-category constructive computation.
Secondary: Chaotic wavelet compositional. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._sc=[2,4,8]
    def _ncd(self,a,b):
