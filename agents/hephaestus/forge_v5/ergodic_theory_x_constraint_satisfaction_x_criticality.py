"""CAITL v5 (metacognition-enhanced) Ergodic Constraint Critical: mixing arc-consistency + sandpile. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Ergodic Constraint Critical: mixing arc-consistency + sandpile v4."""
    TAG="ECSC"
