"""CAITL v5 (metacognition-enhanced) — Fractal Predictive Coding Network. Multi-scale structural parsing
...
class ReasoningTool:
    """Fractal Predictive Coding Network v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="FPCN-v4"
