"""CAITL v5 (metacognition-enhanced) — Chaotic Active-Inference Compositor. Logistic-map probing + compositional
structure verification + active-inference belief update.
...
class ReasoningTool:
    """Chaotic Active-Inference Compositor v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="CAIC-v4"
