"""CAITL v5 (metacognition-enhanced) — Genetic-Dialectical Mechanism Reasoner. Thesis/antithesis validation +
genetic fitness + mechanism-design truth-seeking.
...
class ReasoningTool:
    """Genetic-Dialectical Mechanism Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="GDMR-v4"
