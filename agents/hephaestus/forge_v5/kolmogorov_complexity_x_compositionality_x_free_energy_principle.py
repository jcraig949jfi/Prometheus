"""CAITL v5 (metacognition-enhanced) — Compositional KC Free-Energy Reasoner (CKFER).
...
class ReasoningTool:
    """Compositional KC Free-Energy Reasoner v4. struct>=52% comp>=23% ncd<=10%."""
    TAG="CKFER-v4"
    def evaluate(self,prompt:str,candidates:List[str])->List[Dict]:
        ...
        for c in candidates:
            ...
            rparts=[f"st={st:.3f}(w={w:.2f})",f"cp={cs:.3f}",f"nc={nc:.3f}",f"kc={lr:.3f}"]
