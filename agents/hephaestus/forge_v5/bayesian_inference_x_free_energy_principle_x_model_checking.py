"""v5 (metacognition-enhanced) VBMC variational Bayesian model checker — 58-category constructive computation.
Secondary: VBMC variational Bayesian model checker. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
