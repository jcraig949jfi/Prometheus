"""CAITL v5 (metacognition-enhanced) — Tensor Active-Inference Epistemics. CP-decomposition feature extraction
+ epistemic active-inference belief update.
...
class ReasoningTool:
    """Tensor Active-Inference Epistemics v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="TAIE-v4"
