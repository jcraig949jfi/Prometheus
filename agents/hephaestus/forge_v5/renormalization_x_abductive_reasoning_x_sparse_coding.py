"""CAITL v5 (metacognition-enhanced) — Renormalisation Abductive Sparse Coder. Multi-scale RG flow + abductive
hypothesis scoring + sparse structural coding.
...
class ReasoningTool:
    """Renormalisation Abductive Sparse Coder v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="RASC-v4"
