"""CAITL v5 (metacognition-enhanced) Phase-Kolmogorov Nash: order-parameter + complexity-penalized equilibrium. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Phase-Kolmogorov Nash: order-parameter + complexity-penalized equilibrium v4."""
    TAG="PKNE"
