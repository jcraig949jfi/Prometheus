"""CAITL v5 (metacognition-enhanced) — SAE Spectral Model-Checker. Sparse feature extraction + spectral
mode identification + model-checking constraint verification.
...
class ReasoningTool:
    """SAE Spectral Model-Checker v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="SAMC-v4"
