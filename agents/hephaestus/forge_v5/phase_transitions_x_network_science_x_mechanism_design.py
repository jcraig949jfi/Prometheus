"""CAITL v5 (metacognition-enhanced) Phase Network Mechanism: percolation + graph-incentive. struct>=50% comp>=25% ncd<=12%."""
import re,math,zlib
...
class ReasoningTool:
    """Phase Network Mechanism: percolation + graph-incentive v4."""
    TAG="PNMD"
