"""CAITL v5 (metacognition-enhanced) Ergodic Causal SAT: mixing causal-graph + DPLL propagation. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Ergodic Causal SAT: mixing causal-graph + DPLL propagation v4."""
    TAG="ECIS"
