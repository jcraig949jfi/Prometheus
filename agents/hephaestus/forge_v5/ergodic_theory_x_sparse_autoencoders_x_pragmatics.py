"""v5 (metacognition-enhanced) Ergodic SAE sparse pragmatic — 58-category constructive computation.
Secondary: Ergodic SAE sparse pragmatic. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._sp=0.05
    def _ncd(self,a,b):
