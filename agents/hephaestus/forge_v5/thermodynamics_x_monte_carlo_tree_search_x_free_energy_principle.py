"""v5 (metacognition-enhanced) VF-MCTS energy-entropy — 58-category constructive computation.
Secondary: VF-MCTS energy-entropy. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._ce=0.5
    def _ncd(self,a,b):
