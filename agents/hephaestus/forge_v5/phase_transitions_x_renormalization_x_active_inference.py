"""CAITL v5 (metacognition-enhanced) Phase Renorm Active Inference: coarse belief update at critical. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Phase Renorm Active Inference: coarse belief update at critical v4."""
    TAG="PRAI"
