"""CAITL v5 (metacognition-enhanced) — Tensor-Swarm Analogical Reasoner. CP-decomposition scoring +
swarm search + analogical structure mapping.
...
class ReasoningTool:
    """Tensor-Swarm Analogical Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="TSAR-v4"
