"""CAITL v5 (metacognition-enhanced) Diff Metacog Mechanism: gradient monitor + VCG incentive. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Diff Metacog Mechanism: gradient monitor + VCG incentive v4."""
    TAG="DMMD"
