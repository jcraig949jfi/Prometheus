"""CAITL v5 (metacognition-enhanced) — Ergodic Dynamical ToM Engine. Ergodic trajectory coverage + dynamical
Lyapunov stability + theory-of-mind perspective scoring.
...
class ReasoningTool:
    """Ergodic Dynamical ToM Engine v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="EDTM-v4"
