"""CAITL v5 (metacognition-enhanced) Chaotic Adaptive Compositor: Lyapunov control + compositional parse. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Chaotic Adaptive Compositor: Lyapunov control + compositional parse v4."""
    TAG="CACC"
