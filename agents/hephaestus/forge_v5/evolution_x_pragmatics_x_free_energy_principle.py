"""v5 (metacognition-enhanced) Evolutionary pragmatic FEP — 58-category constructive computation.
Secondary: Evolutionary pragmatic FEP. Primary: structural+computational parsers.
"""
import re, zlib
import numpy as np
...
class ReasoningTool:
    def __init__(self): self._mr=0.05
    def _ncd(self,a,b):
