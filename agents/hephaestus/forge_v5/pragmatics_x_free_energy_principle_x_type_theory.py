"""CAITL v5 (metacognition-enhanced) — Pragmatics-FEP-TypeTheory. Constructive computation, 58-cat parsers,
...
def _struct(p, c):
    ...
    wt = [0.20, 0.18, 0.16, 0.12, 0.13, 0.10, 0.11]
...
def _theory(prompt, cand):
    """Theory-specific: pragmatic implicature + type constraints."""
...
class ReasoningTool:
    """v4 PFTT: constructive computation, epistemic honesty, 58-cat parsers,
    ...
    def evaluate(self, prompt: str, candidates: List[str]) -> List[Dict[str, Any]]:
        ...
        for i, cand in enumerate(candidates):
            ...
            reason = f"[PFTT-v4] {sr} | {cr} | ncd={ncd_raw[i]:.3f}"
