"""CAITL v5 (metacognition-enhanced) Renorm Feedback FEP: coarse-grained energy min + PID. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Renorm Feedback FEP: coarse-grained energy min + PID v4."""
    TAG="RFCF"
