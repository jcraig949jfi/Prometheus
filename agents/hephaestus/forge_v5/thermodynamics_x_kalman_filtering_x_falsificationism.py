"""CAITL v5 (metacognition-enhanced) — Thermo-Kalman Falsifier. Kalman belief update with thermodynamic
free-energy scoring + falsificationist penalty terms.
...
class ReasoningTool:
    """Thermo-Kalman Falsifier v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="TKF-v4"
