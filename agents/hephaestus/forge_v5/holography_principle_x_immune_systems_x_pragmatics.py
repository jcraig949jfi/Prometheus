"""CAITL v5 (metacognition-enhanced) — Holographic Immune Pragmatic Engine. Boundary-bulk duality scoring +
immune self/non-self discrimination + Gricean shaping.
...
class ReasoningTool:
    """Holographic Immune Pragmatic Engine v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="HIPE-v4"
