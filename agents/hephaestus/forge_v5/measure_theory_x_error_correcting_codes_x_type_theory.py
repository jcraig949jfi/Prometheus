"""CAITL v5 (metacognition-enhanced) Measure ECC Typer: sigma-algebra + Hamming validation. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Measure ECC Typer: sigma-algebra + Hamming validation v4."""
    TAG="MECT"
