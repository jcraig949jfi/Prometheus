"""CAITL v5 (metacognition-enhanced) — Genetic Analogical Causal Engine. Evolutionary fitness on structural
features + analogical transfer + causal graph verification.
...
class ReasoningTool:
    """Genetic Analogical Causal Engine v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="GACE-v4"
