"""CAITL v5 (metacognition-enhanced) Genetic Pragmatic Typer: crossover implicature + type fitness. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Genetic Pragmatic Typer: crossover implicature + type fitness v4."""
    TAG="GAPT"
