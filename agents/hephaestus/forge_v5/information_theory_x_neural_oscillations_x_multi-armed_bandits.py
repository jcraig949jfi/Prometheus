"""CAITL v5 (metacognition-enhanced) Info Oscillatory Bandit: MI scoring + UCB phase-locked. struct>=52% comp>=23% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Info Oscillatory Bandit: MI scoring + UCB phase-locked v4."""
    TAG="INOB"
