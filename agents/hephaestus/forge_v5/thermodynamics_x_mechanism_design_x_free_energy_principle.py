"""CAITL v5 (metacognition-enhanced) Thermo Mechanism FEP: VCG energy min + entropy reg. struct>=50% comp>=25% ncd<=10%."""
import re,math,zlib
...
class ReasoningTool:
    """Thermo Mechanism FEP: VCG energy min + entropy reg v4."""
    TAG="TMDF"
