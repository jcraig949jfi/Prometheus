"""CAITL v5 (metacognition-enhanced) — Thermodynamic Ergodic Free-Energy Reasoner. Free-energy minimisation
over ergodic state space + structural constraint energy + NCD prior.
...
class ReasoningTool:
    """Thermodynamic Ergodic Free-Energy Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="TEFR-v4"
