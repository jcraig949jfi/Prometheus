"""CAITL v5 (metacognition-enhanced) — Fractal Mechanism Type-Director. Multi-scale fractal feature extraction +
mechanism-design ranking + dependent-type verification.
...
class ReasoningTool:
    """Fractal Mechanism Type-Director v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="FMTD-v4"
