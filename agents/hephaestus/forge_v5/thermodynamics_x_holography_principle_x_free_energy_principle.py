"""CAITL v5 (metacognition-enhanced) — Thermodynamic-Holographic Free-Energy Reasoner. Holographic
information bound + free-energy minimisation + ensemble normalisation.
...
class ReasoningTool:
    """Thermodynamic-Holographic Free-Energy Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="THFR-v4"
