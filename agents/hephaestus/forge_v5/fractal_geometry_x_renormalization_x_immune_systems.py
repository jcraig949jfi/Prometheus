"""CAITL v5 (metacognition-enhanced) — Fractal-Renormalised Immune Reasoner. RG coarse-graining +
fractal self-similarity + clonal selection fitness.
...
class ReasoningTool:
    """Fractal-Renormalised Immune Reasoner v4 struct>=50% comp>=20% ncd<=15%."""
    TAG="FRIR-v4"
