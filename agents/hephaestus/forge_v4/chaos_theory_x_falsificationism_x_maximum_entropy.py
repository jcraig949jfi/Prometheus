...
class ReasoningTool:
    """Chaotic MaxEnt Falsification Engine v4. Lorenz-seeded perturbation with
    Popperian constraint checking across 58 evaluation categories.
    ...
    def evaluate(self, prompt: str, candidates: List[str]) -> List[Dict]:
        ...
        for ct in candidates:
            ...
            sc = max(0, min(1, (0.54*st + 0.31*cp + 0.15*ns) * g))
    ...
    def confidence(self, prompt: str, answer: str) -> float:
        ...
        return max(0.0, min(1.0, (0.54*st + 0.31*cp) * g))
