"""measure_theory x mechanism_design x type_theory v3.
Measure Theory X Mechanism Design X Type Theory.
...
class ReasoningTool:
    """Measure-Theoretic Mechanism Type Checker v3: 15-category structural parser + measure_density secondary."""
    ...
    def _theme(self, prompt, cand):
        """measure_density: theme-specific secondary signal 0-1."""
