"""gene_regulatory_networks x multi-armed_bandits x free_energy_principle v3.
Gene Regulatory Networks X Multi-Armed Bandits X Free Energy Principle.
...
class ReasoningTool:
    """Gene Regulatory Bandit FEP v3: 15-category structural parser + regulatory_fitness secondary."""
    ...
    def _theme(self, prompt, cand):
        """regulatory_fitness: theme-specific secondary signal 0-1."""
