"""CAITL v3 -- KC-Hebbian-Mech v3: compression complexity + associative learning + general category parsers.
...
class ReasoningTool:
    """KC-Hebbian-Mech v3: compression complexity + associative learning + general category parsers."""
