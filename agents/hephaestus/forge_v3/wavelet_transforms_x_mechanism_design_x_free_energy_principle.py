"""CAITL v3 -- Wavelet-Mech-FEP v3: multi-resolution Haar + VCG incentive + variational FE + general category parsers.
...
class ReasoningTool:
    """Wavelet-Mech-FEP v3: multi-resolution Haar + VCG incentive + variational FE + general category parsers."""
