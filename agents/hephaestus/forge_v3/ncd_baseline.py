...
class ReasoningTool:
    """NCD Baseline v3 with Category Parsers v3: 15-category structural parser + compression_ratio secondary."""
    ...
    def _theme(self, prompt, cand):
        """compression_ratio: theme-specific secondary signal 0-1."""
