"""CAITL v3 -- Immune-Phenom-Pragmatic v3: clonal selection + phenomenological reduction + general category parsers.
...
class ReasoningTool:
    """Immune-Phenom-Pragmatic v3: clonal selection + phenomenological reduction + general category parsers."""
