"""thermodynamics x epistemology x free_energy_principle v3.
Thermodynamics X Epistemology X Free Energy Principle.
...
class ReasoningTool:
    """Thermodynamic Epistemic FEP Scorer v3: 15-category structural parser + epistemic_entropy secondary."""
    ...
    def _theme(self, prompt, cand):
        """epistemic_entropy: theme-specific secondary signal 0-1."""
