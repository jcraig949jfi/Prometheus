"""neural_plasticity x abductive_reasoning x pragmatics v3.
Neural Plasticity X Abductive Reasoning X Pragmatics.
...
class ReasoningTool:
    """Hebbian Abductive Pragmatic Scorer v3: 15-category structural parser + hebbian_trace secondary."""
    ...
    def _theme(self, prompt, cand):
        """hebbian_trace: theme-specific secondary signal 0-1."""
