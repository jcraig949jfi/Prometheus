"""CAITL v3 -- Bayes-FEP-Sensitivity v3: factor-graph inference + variational FE + perturbation analysis + general category parsers.
...
class ReasoningTool:
    """Bayes-FEP-Sensitivity v3: factor-graph inference + variational FE + perturbation analysis + general category parsers."""
