"""Phase-Transition Mechanism FEP v3.
Phase Transitions x Mechanism Design x Free Energy Principle.
Order parameter + VCG scoring + FEP minimization, NCD<=15%.
"""
import re, zlib, math
from typing import List, Dict

class ReasoningTool:
    """PTMF v3: phase transition detection + mechanism design + FEP + full trap coverage."""
