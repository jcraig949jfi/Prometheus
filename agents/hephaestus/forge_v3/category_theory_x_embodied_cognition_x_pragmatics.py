"""category_theory x embodied_cognition x pragmatics v3.
Category Theory X Embodied Cognition X Pragmatics.
...
class ReasoningTool:
    """Categorical Embodied Pragmatic Functor v3: 15-category structural parser + morphism_overlap secondary."""
    ...
    def _theme(self, prompt, cand):
        """morphism_overlap: theme-specific secondary signal 0-1."""
