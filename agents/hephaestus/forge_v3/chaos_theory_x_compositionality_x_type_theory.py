"""CAITL v3 -- Chaos-Comp-Type v3: logistic divergence + compositional scoring + type safety + general category parsers.
...
class ReasoningTool:
    """Chaos-Comp-Type v3: logistic divergence + compositional scoring + type safety + general category parsers."""
