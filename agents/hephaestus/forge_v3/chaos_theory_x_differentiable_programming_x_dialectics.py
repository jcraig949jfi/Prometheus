"""chaos_theory x differentiable_programming x dialectics v3.
Chaos Theory X Differentiable Programming X Dialectics.
...
class ReasoningTool:
    """Chaotic Differentiable Dialectic v3: 15-category structural parser + gradient_stability secondary."""
    ...
    def _theme(self, prompt, cand):
        """gradient_stability: theme-specific secondary signal 0-1."""
