"""CAITL v3 -- Analogical-Pragmatic-Type v3: analogical mapping + type safety + general category parsers.
...
class ReasoningTool:
    """Analogical-Pragmatic-Type v3: analogical mapping + type safety + general category parsers."""
