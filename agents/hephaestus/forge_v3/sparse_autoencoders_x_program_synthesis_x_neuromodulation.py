"""sparse_autoencoders x program_synthesis x neuromodulation v3.
Sparse Autoencoders X Program Synthesis X Neuromodulation.
...
class ReasoningTool:
    """Neuromodulated Sparse Program Synth v3: 15-category structural parser + gain_modulated_sparsity secondary."""
    ...
    def _theme(self, prompt, cand):
        """gain_modulated_sparsity: theme-specific secondary signal 0-1."""
