"""CAITL v3 -- Ergodic-DiffProg-Immune v3: ergodic exploration + gradient signals + clonal selection + general category parsers.
...
class ReasoningTool:
    """Ergodic-DiffProg-Immune v3: ergodic exploration + gradient signals + clonal selection + general category parsers."""
