"""CAITL v3 -- Swarm-Meta-Mech v3: multi-agent parsing + Bayesian calibration + VCG incentive + general category parsers.
...
class ReasoningTool:
    """Swarm-Meta-Mech v3: multi-agent parsing + Bayesian calibration + VCG incentive + general category parsers."""
