"""chaos_theory x falsificationism x maximum_entropy v3.
Chaos Theory X Falsificationism X Maximum Entropy.
...
class ReasoningTool:
    """Chaotic Falsificationist MaxEnt Scorer v3: 15-category structural parser + lyapunov_penalty secondary."""
    ...
    def _theme(self, prompt, cand):
        """lyapunov_penalty: theme-specific secondary signal 0-1."""
