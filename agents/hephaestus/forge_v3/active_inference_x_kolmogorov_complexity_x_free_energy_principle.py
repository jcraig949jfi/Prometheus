"""active_inference x kolmogorov_complexity x free_energy_principle v3.
Active Inference X Kolmogorov Complexity X Free Energy Principle.
...
class ReasoningTool:
    """Active KC Free Energy Minimizer v3: 15-category structural parser + description_length secondary."""
    ...
    def _theme(self, prompt, cand):
        """description_length: theme-specific secondary signal 0-1."""
