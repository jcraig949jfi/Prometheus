"""theory_of_mind x mechanism_design x sensitivity_analysis v3.
Theory Of Mind X Mechanism Design X Sensitivity Analysis.
...
class ReasoningTool:
    """ToM Mechanism Sensitivity Analyzer v3: 15-category structural parser + belief_divergence secondary."""
    ...
    def _theme(self, prompt, cand):
        """belief_divergence: theme-specific secondary signal 0-1."""
