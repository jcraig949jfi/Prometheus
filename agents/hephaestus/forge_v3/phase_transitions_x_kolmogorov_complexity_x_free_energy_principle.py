"""CAITL v3 -- Phase-KC-FEP v3: criticality detection + compression complexity + free energy + general category parsers.
...
class ReasoningTool:
    """Phase-KC-FEP v3: criticality detection + compression complexity + free energy + general category parsers."""
