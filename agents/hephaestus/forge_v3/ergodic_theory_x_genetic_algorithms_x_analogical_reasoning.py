"""CAITL v3 -- Ergodic-GA-Analogy v3: ergodic averaging + fitness selection + analogical mapping + general category parsers.
...
class ReasoningTool:
    """Ergodic-GA-Analogy v3: ergodic averaging + fitness selection + analogical mapping + general category parsers."""
