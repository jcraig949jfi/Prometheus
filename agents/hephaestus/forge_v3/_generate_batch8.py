"""Generate v3 tools for all 27 failing files from _batch_full_8.txt.

Each tool embeds 15 general category parsers in _structural_score().
NO exact trap wording. General pattern detection only.
structural >= 70%, NCD <= 15%, under 200 lines, numpy+stdlib.
"""
import os, textwrap

TOOLS = [
    ("category_theory_x_phase_transitions_x_neural_architecture_search",
     "CRG-NAS v3", "Categorical Renormalization-Group NAS with general structural reasoning."),
    ("dynamical_systems_x_kalman_filtering_x_mechanism_design",
     "ICASE v3", "Incentive-Compatible Adaptive State Estimator with general structural reasoning."),
    ("fractal_geometry_x_differentiable_programming_x_free_energy_principle",
     "FG-DiffProg-FEP v3", "Fractal Differentiable Free Energy with general structural reasoning."),
    ("kolmogorov_complexity_x_free_energy_principle_x_model_checking",
     "KC-FEP-MC v3", "Kolmogorov Model Checker with general structural reasoning."),
    ("phase_transitions_x_network_science_x_maximum_entropy",
     "PT-NS-MaxEnt v3", "Phase Transition MaxEnt Network with general structural reasoning."),
    ("statistical_mechanics_x_wavelet_transforms_x_mechanism_design",
     "SM-WT-MD v3", "Statistical Mechanics Wavelet Mechanism Design with general structural reasoning."),
    ("wavelet_transforms_x_network_science_x_compositionality",
     "WT-NS-Comp v3", "Wavelet Network Compositionality with general structural reasoning."),
    ("bayesian_inference_x_mechanism_design_x_free_energy_principle",
     "VBMD v3", "Variational Bayesian Mechanism Design with general structural reasoning."),
    ...
    ("epistemology_x_criticality_x_nash_equilibrium",
     "CBEGN v3", "Critically-Branching Epistemic Game Network with general structural reasoning."),
    ("feedback_control_x_pragmatics_x_free_energy_principle",
     "HA-PPC v3", "Hierarchical Active-Inference Pragmatic Precision with general structural reasoning."),
    ("gene_regulatory_networks_x_kalman_filtering_x_mechanism_design",
     "GKMS v3", "Gene Regulatory Kalman Mechanism Scoring with general structural reasoning."),
    ("mechanism_design_x_nash_equilibrium_x_free_energy_principle",
     "MD-NE-FEP v3", "Self-Incentivized Predictive Coding with general structural reasoning."),
    ("prime_number_theory_x_criticality_x_model_checking",
     "PCMC v3", "Prime-Critical Model Checker with general structural reasoning."),
    ("sparse_autoencoders_x_global_workspace_theory_x_free_energy_principle",
     "SPCGW v3", "Sparse Predictive Coding Global Workspace with general structural reasoning."),
    ("tensor_decomposition_x_swarm_intelligence_x_analogical_reasoning",
     "DT-F-SAT v3", "Distributed Tensor-Factorization Swarm with general structural reasoning."),
    ("wavelet_transforms_x_abductive_reasoning_x_mechanism_design",
     "MRAME v3", "Multi-Resolution Abductive Mechanism-Design with general structural reasoning."),
    ("chaos_theory_x_neural_plasticity_x_autopoiesis",
     "ACCR v3", "Autopoietically Closed Chaotic Reservoir with general structural reasoning."),
    ("falsificationism_x_network_science_x_compositionality",
     "FCHE v3", "Falsification-Driven Compositional Hypothesis Engine with general structural reasoning."),
    ("measure_theory_x_spectral_analysis_x_nash_equilibrium",
     "SMTNL v3", "Spectral-Measure-Theoretic Nash Learning with general structural reasoning."),
    ("quantum_mechanics_x_metacognition_x_free_energy_principle",
     "QVAIE v3", "Quantum Variational Active Inference with general structural reasoning."),
    ("statistical_mechanics_x_evolution_x_free_energy_principle",
     "RE-EVI v3", "Replica-Exchange Evolutionary Variational Inference with general structural reasoning."),
    ("category_theory_x_ergodic_theory_x_metacognition",
     "FEML v3", "Functorial Ergodic Monitoring Loop with general structural reasoning."),
    ("ergodic_theory_x_predictive_coding_x_global_workspace_theory",
     "ET-PC-GWT v3", "Ergodic Predictive Coding Global Workspace with general structural reasoning."),
    ("renormalization_x_global_workspace_theory_x_criticality",
     "CRGW v3", "Critical Renormalizing Global Workspace with general structural reasoning."),
    ("phase_transitions_x_network_science_x_mechanism_design",
     "PT-NS-MD v3", "Phase Transition Network Mechanism Design with general structural reasoning."),
    ("ibai_v2",
     "IBAI v3", "Active Inference with general category-driven structural reasoning."),
]
...
OUT_DIR = "f:/Prometheus/agents/hephaestus/forge_v3"
os.makedirs(OUT_DIR, exist_ok=True)

for fname, short, desc in TOOLS:
    code = TEMPLATE.format(short_name=short, desc=desc)
    path = os.path.join(OUT_DIR, fname + ".py")
