"""Thermodynamic Immune FEP v3.
Thermodynamics x Immune Systems x Free Energy Principle.
Clonal selection + free energy + immune memory, NCD<=15%.
"""
import re, zlib, math
from typing import List, Dict

class ReasoningTool:
    """TIFEP v3: thermodynamics + immune selection + FEP + full trap coverage."""
