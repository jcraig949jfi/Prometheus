"""CAITL v3 -- Thermo-SAE-Comp v3: energy minimization + sparse features + compositional scoring + general category parsers.
...
class ReasoningTool:
    """Thermo-SAE-Comp v3: energy minimization + sparse features + compositional scoring + general category parsers."""
