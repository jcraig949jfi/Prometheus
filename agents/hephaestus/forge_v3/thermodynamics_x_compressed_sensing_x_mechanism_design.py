"""thermodynamics x compressed_sensing x mechanism_design v3.
Thermodynamics X Compressed Sensing X Mechanism Design.
...
class ReasoningTool:
    """Thermodynamic Compressed Sensing Mechanism v3: 15-category structural parser + free_energy_gap secondary."""
    ...
    def _theme(self, prompt, cand):
        """free_energy_gap: theme-specific secondary signal 0-1."""
