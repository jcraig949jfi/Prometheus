"""fractal_geometry x mechanism_design x type_theory v3.
Fractal Geometry X Mechanism Design X Type Theory.
...
class ReasoningTool:
    """Fractal-Guided Incentivized Tactic Search v3: 15-category structural parser + fractal_ncd_ratio secondary."""
    ...
    def _theme(self, prompt, cand):
        """fractal_ncd_ratio: theme-specific secondary signal 0-1."""
