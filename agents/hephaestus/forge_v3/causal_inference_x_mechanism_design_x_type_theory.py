"""CAITL v3 -- Causal-Mech-Type v3: causal graph + VCG reward + type checking + general category parsers.
...
class ReasoningTool:
    """Causal-Mech-Type v3: causal graph + VCG reward + type checking + general category parsers."""
