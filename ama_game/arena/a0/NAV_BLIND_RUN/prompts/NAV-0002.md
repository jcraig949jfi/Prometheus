...
- run id: `A0NAV-NAV-0002`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/NAV_BLIND_RUN/runs/NAV-0002/claim.json`
- your working directory: `F:/Prometheus/ama_game/arena/a0/NAV_BLIND_RUN/runs/NAV-0002`
- your submission record: `F:/Prometheus/ama_game/arena/a0/NAV_BLIND_RUN/runs/NAV-0002/disposition.json`
- metered session id: `A0NAV_BLIND-NAV-0002`
...
```
python F:/Prometheus/ama_game/arena/verifier/meter_cli.py remaining --session A0NAV_BLIND-NAV-0002
python F:/Prometheus/ama_game/arena/verifier/meter_cli.py evaluate  --session A0NAV_BLIND-NAV-0002 --point N
python F:/Prometheus/ama_game/arena/verifier/meter_cli.py sample    --session A0NAV_BLIND-NAV-0002 --point N
python F:/Prometheus/ama_game/arena/verifier/meter_cli.py range     --session A0NAV_BLIND-NAV-0002 --lo A --hi B
```
...
Write `F:/Prometheus/ama_game/arena/a0/NAV_BLIND_RUN/runs/NAV-0002/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0NAV-NAV-0002",
  "condition": "A",
  "claim_id": "NAV-0002",
  "session": "A0NAV_BLIND-NAV-0002",
...
```json
{
  "claim_id": "NAV-0002",
  "kind": "navigation",
  "proposition": "Let f be the sequence held by the arena. For every integer n with 1 <= n <= 600, f(n) mod 1009 is not 848.",
