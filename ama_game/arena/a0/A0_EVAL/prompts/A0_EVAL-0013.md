...
- run id: `A0-A0_EVAL-0013`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0013/claim.json`
- problem: `t5_collatz_stopping_time`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0013`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0013/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0013/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0013",
  "condition": "A",
  "claim_id": "A0_EVAL-0013",
...
```json
{
  ...
  "proposition": "Under the map n -> n/2 when n is even, n -> 3n+1 when n is odd, every integer n with 1 <= n <= 135465 reaches 1 in fewer than 276 steps.",
  "domain": "integers n with 1 <= n <= 135465",
  "quantifiers": "for all n in [1, 135465]",
  "hypotheses": [
  ...
  "argument": [
    ...
    {
      "id": "s2",
      "text": "A direct sweep verifies that every n in [1, 2956] has stopping time below 276.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s8",
      "text": "The sweep covers [1, 2956]; the statement is asserted for every n in [1, 135465].",
      "depends_on": [
        "s6",
        "s7"
      ]
