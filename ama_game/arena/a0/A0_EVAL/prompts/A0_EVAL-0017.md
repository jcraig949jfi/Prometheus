...
- run id: `A0-A0_EVAL-0017`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0017/claim.json`
- problem: `t5_collatz_stopping_time`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0017`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0017/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0017/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0017",
  "condition": "A",
  "claim_id": "A0_EVAL-0017",
...
```json
{
  ...
  "proposition": "Under the map n -> n/2 when n is even, n -> 3n+1 when n is odd, every integer n with 1 <= n <= 5489 reaches 1 in fewer than 238 steps.",
  "domain": "integers n with 1 <= n <= 5489",
  "quantifiers": "for all n in [1, 5489]",
  "hypotheses": [
  ...
  "argument": [
    {
      "id": "s1",
      "text": "Every n in [1, 50] has stopping time below 238; the smallest values are checked directly.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "A direct sweep verifies that every n in [1, 5489] has stopping time below 238.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s5",
      "text": "For every integer n with 1 <= n <= 2000: CONVERSE: if n is divisible by 4 then n(n+1)/2 is even. (the implication is used in the reverse direction below)",
      "depends_on": [
        "s3",
        "s4"
      ]
    ...
    {
      "id": "s9",
      "text": "The sweep covers [1, 5489]; the statement is asserted for every n in [1, 5489].",
      "depends_on": [
        "s7",
        "s8"
      ]
