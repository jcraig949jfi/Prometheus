...
- run id: `A0-A0_EVAL-0011`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0011/claim.json`
- problem: `t4_linear_recurrence`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0011`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0011/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0011/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0011",
  "condition": "A",
  "claim_id": "A0_EVAL-0011",
...
```json
{
  ...
  "proposition": "Let a_0 = 4, a_1 = 10 and a_n = 6*a_(n-1) + (-8)*a_(n-2) for n >= 2. Then for every n with 0 <= n <= 30, a_n = 4*2^n + 1*4^n.",
  "domain": "integers n with 0 <= n <= 30",
  "quantifiers": "for all n in [0, 30]",
  "hypotheses": [
  ...
  "argument": [
    {
      "id": "s1",
      "text": "At n = 0 the closed form gives 5, matching a_0 = 4.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "At n = 1 the closed form gives 12, matching a_1 = 10.",
      "depends_on": [
        "s1"
      ]
    },
    {
      "id": "s3",
      "text": "The closed form satisfies the recurrence: for every n in [0, 28], f(n+2) = 6*f(n+1) + (-8)*f(n).",
      "depends_on": [
        "s1",
        "s2"
      ]
    ...
    {
      "id": "s5",
      "text": "For every integer n with 1 <= n <= 30, n^3 is congruent to n modulo 6.",
      "depends_on": [
        "s3",
        "s4"
      ]
    ...
    {
      "id": "s9",
      "text": "Two base cases plus the recurrence identity give the closed form for every n in [0, 30].",
      "depends_on": [
        "s7",
        "s8"
      ]
