...
- run id: `A0-A0_EVAL-0003`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0003/claim.json`
- problem: `t5_collatz_stopping_time`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0003`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0003/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0003/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0003",
  "condition": "A",
  "claim_id": "A0_EVAL-0003",
...
```json
{
  ...
  "proposition": "Under the map n -> n/2 when n is even, n -> 3n+1 when n is odd, every integer n with 1 <= n <= 169472 reaches 1 in fewer than 354 steps.",
  "domain": "integers n with 1 <= n <= 169472",
  "quantifiers": "for all n in [1, 169472]",
  "hypotheses": [
  ...
  "argument": [
    {
      "id": "s1",
      "text": "Every n in [1, 50] has stopping time below 354; the smallest values are checked directly.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "A direct sweep verifies that every n in [1, 2020] has stopping time below 354.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s7",
      "text": "The sweep covers [1, 2020]; the statement is asserted for every n in [1, 169472].",
      "depends_on": [
        "s5",
        "s6"
      ]
