...
- run id: `A0-A0_EVAL-0029`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0029/claim.json`
- problem: `t5_collatz_stopping_time`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0029`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0029/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0029/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0029",
  "condition": "A",
  "claim_id": "A0_EVAL-0029",
...
```json
{
  ...
  "proposition": "Under the map n -> n/2 when n is even, n -> 3n+1 when n is odd, every integer n with 1 <= n <= 344348 reaches 1 in fewer than 386 steps.",
  "domain": "integers n with 1 <= n <= 344348",
  "quantifiers": "for all n in [1, 344348]",
  "hypotheses": [
  ...
  "argument": [
    ...
    {
      "id": "s2",
      "text": "A direct sweep verifies that every n in [1, 1002] has stopping time below 386.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s6",
      "text": "The sweep covers [1, 1002]; the statement is asserted for every n in [1, 344348].",
      "depends_on": [
        "s4",
        "s5"
      ]
