...
- run id: `A0-A0_EVAL-0018`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0018/claim.json`
- problem: `t5_collatz_stopping_time`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0018`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0018/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0018/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0018",
  "condition": "A",
  "claim_id": "A0_EVAL-0018",
...
```json
{
  ...
  "proposition": "Under the map n -> n/2 when n is even, n -> 3n+1 when n is odd, every integer n with 1 <= n <= 85828 reaches 1 in fewer than 279 steps.",
  "domain": "integers n with 1 <= n <= 85828",
  "quantifiers": "for all n in [1, 85828]",
  "hypotheses": [
  ...
  "argument": [
    ...
    {
      "id": "s2",
      "text": "A direct sweep verifies that every n in [1, 1806] has stopping time below 279.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s7",
      "text": "The sweep covers [1, 1806]; the statement is asserted for every n in [1, 85828].",
      "depends_on": [
        "s5",
        "s6"
      ]
