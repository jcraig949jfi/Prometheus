...
- run id: `A0-A0_EVAL-0007`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0007/claim.json`
- problem: `t2_modular_power_cycle`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0007`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0007/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0007/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0007",
  "condition": "A",
  "claim_id": "A0_EVAL-0007",
...
```json
{
  ...
  "proposition": "For every integer n with 0 <= n <= 80, 3^n is congruent to 3^(n mod 3) modulo 13.",
  ...
  "argument": [
    {
      "id": "s1",
      "text": "At n = 1 both sides equal 1 modulo 13.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "The residue 3 has order 3 modulo 13: for every n in [0, 77], 3^(n+3) is congruent to 3^n modulo 13.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s5",
      "text": "For every n in [0, 80]: if 3 divides n then 3^n is congruent to 1 modulo 13.",
      "depends_on": [
        "s3",
        "s4"
      ]
    ...
    {
      "id": "s9",
      "text": "Every n in [0, 80] falls in exactly one residue class modulo 3.",
      "depends_on": [
        "s7",
        "s8"
      ]
