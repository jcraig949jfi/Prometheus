...
- run id: `A0-A0_EVAL-0014`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0014/claim.json`
- problem: `t5_collatz_stopping_time`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0014`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0014/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0014/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0014",
  "condition": "A",
  "claim_id": "A0_EVAL-0014",
...
```json
{
  ...
  "proposition": "Under the map n -> n/2 when n is even, n -> 3n+1 when n is odd, every integer n with 1 <= n <= 550662 reaches 1 in fewer than 443 steps.",
  "domain": "integers n with 1 <= n <= 550662",
  "quantifiers": "for all n in [1, 550662]",
  "hypotheses": [
  ...
  "argument": [
    ...
    {
      "id": "s2",
      "text": "A direct sweep verifies that every n in [1, 2014] has stopping time below 443.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s7",
      "text": "The sweep covers [1, 2014]; the statement is asserted for every n in [1, 550662].",
      "depends_on": [
        "s5",
        "s6"
      ]
