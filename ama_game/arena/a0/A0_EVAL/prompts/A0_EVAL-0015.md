...
- run id: `A0-A0_EVAL-0015`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0015/claim.json`
- problem: `t5_collatz_stopping_time`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0015`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0015/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0015/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0015",
  "condition": "A",
  "claim_id": "A0_EVAL-0015",
...
```json
{
  ...
  "proposition": "Under the map n -> n/2 when n is even, n -> 3n+1 when n is odd, every integer n with 1 <= n <= 2839 reaches 1 in fewer than 209 steps.",
  "domain": "integers n with 1 <= n <= 2839",
  "quantifiers": "for all n in [1, 2839]",
  "hypotheses": [
  ...
  "argument": [
    {
      "id": "s1",
      "text": "Every n in [1, 50] has stopping time below 209; the smallest values are checked directly.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "A direct sweep verifies that every n in [1, 2839] has stopping time below 209.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s9",
      "text": "The sweep covers [1, 2839]; the statement is asserted for every n in [1, 2839].",
      "depends_on": [
        "s7",
        "s8"
      ]
