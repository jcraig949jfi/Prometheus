...
- run id: `A0-A0_EVAL-0006`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0006/claim.json`
- problem: `t2_modular_power_cycle`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0006`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0006/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0006/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0006",
  "condition": "A",
  "claim_id": "A0_EVAL-0006",
...
```json
{
  ...
  "proposition": "For every integer n with 0 <= n <= 60, 8^n is congruent to 8^(n mod 5) modulo 13.",
  ...
  "argument": [
    ...
    {
      "id": "s2",
      "text": "The residue 8 has order 5 modulo 13: for every n in [0, 55], 8^(n+5) is congruent to 8^n modulo 13.",
      "depends_on": [
        "s1"
      ]
    },
    {
      "id": "s3",
      "text": "Every n in [0, 60] falls in exactly one residue class modulo 5.",
      "depends_on": [
        "s1",
        "s2"
      ]
    ...
    {
      "id": "s4",
      "text": "For every n in [0, 60]: if 5 divides n then 8^n is congruent to 1 modulo 13.",
      "depends_on": [
        "s2",
        "s3"
      ]
