...
- run id: `A0-A0_EVAL-0023`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0023/claim.json`
- problem: `t5_collatz_stopping_time`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0023`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0023/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0023/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0023",
  "condition": "A",
  "claim_id": "A0_EVAL-0023",
...
```json
{
  ...
  "proposition": "Under the map n -> n/2 when n is even, n -> 3n+1 when n is odd, every integer n with 1 <= n <= 79400 reaches 1 in fewer than 279 steps.",
  "domain": "integers n with 1 <= n <= 79400",
  "quantifiers": "for all n in [1, 79400]",
  "hypotheses": [
  ...
  "argument": [
    {
      "id": "s1",
      "text": "Every n in [1, 50] has stopping time below 279; the smallest values are checked directly.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "A direct sweep verifies that every n in [1, 2190] has stopping time below 279.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s9",
      "text": "The sweep covers [1, 2190]; the statement is asserted for every n in [1, 79400].",
      "depends_on": [
        "s7",
        "s8"
      ]
