...
- run id: `A0-A0_EVAL-0000`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0000/claim.json`
- problem: `t1_integer_sum_identity`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0000`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0000/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0000/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0000",
  "condition": "A",
  "claim_id": "A0_EVAL-0000",
...
```json
{
  ...
  "proposition": "For every integer n with 1 <= n <= 60, the sum of k^3 for k = 1..n equals (n(n+1)/2)^2.",
  ...
  "argument": [
    ...
    {
      "id": "s2",
      "text": "Write F(n) = (n(n+1)/2)^2. For every n with 1 <= n <= 59, F(n+1) - F(n) = (n+1)^3, which is exactly the term added when the upper limit increases by one.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s7",
      "text": "Let G(n) = F(n) + [n = 3]. Then (n-3)F(n) = (n-3)G(n) for every n in [1, 60].",
      "depends_on": [
        "s5",
        "s6"
      ]
