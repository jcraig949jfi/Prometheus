...
- run id: `A0-A0_EVAL-0026`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0026/claim.json`
- problem: `t2_modular_power_cycle`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0026`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0026/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0026/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0026",
  "condition": "A",
  "claim_id": "A0_EVAL-0026",
...
```json
{
  ...
  "proposition": "For every integer n with 0 <= n <= 60, 6^n is congruent to 6^(n mod 12) modulo 23.",
  ...
  "argument": [
    {
      "id": "s1",
      "text": "At n = 0 both sides equal 1 modulo 23.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "The residue 6 has order 12 modulo 23: for every n in [0, 48], 6^(n+12) is congruent to 6^n modulo 23.",
      "depends_on": [
        "s1"
      ]
    },
    {
      "id": "s3",
      "text": "For every n in [0, 60]: if 12 divides n then 6^n is congruent to 1 modulo 23.",
      "depends_on": [
        "s1",
        "s2"
      ]
    ...
    {
      "id": "s7",
      "text": "Every n in [0, 60] falls in exactly one residue class modulo 12.",
      "depends_on": [
        "s5",
        "s6"
      ]
