...
- run id: `A0-A0_EVAL-0012`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0012/claim.json`
- problem: `t4_linear_recurrence`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0012`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0012/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0012/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0012",
  "condition": "A",
  "claim_id": "A0_EVAL-0012",
...
```json
{
  ...
  "proposition": "Let a_0 = 5, a_1 = 21 and a_n = 9*a_(n-1) + (-20)*a_(n-2) for n >= 2. Then for every n with 0 <= n <= 25, a_n = 4*4^n + 1*5^n.",
  ...
  "argument": [
    {
      "id": "s1",
      "text": "At n = 0 the closed form gives 5, matching a_0 = 5.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "At n = 1 the closed form gives 21, matching a_1 = 21.",
      "depends_on": [
        "s1"
      ]
    },
    {
      "id": "s3",
      "text": "The closed form satisfies the recurrence: for every n in [0, 23], f(n+2) = 9*f(n+1) + (-20)*f(n). (expanding by b^(n+1) expanded as b^n + 1)",
      "depends_on": [
        "s1",
        "s2"
      ]
    ...
    {
      "id": "s5",
      "text": "Every integer n in [1, 25] is even or odd, so the two cases below are exhaustive.",
      "depends_on": [
        "s3",
        "s4"
      ]
