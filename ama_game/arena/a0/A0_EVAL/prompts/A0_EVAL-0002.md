...
- run id: `A0-A0_EVAL-0002`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0002/claim.json`
- problem: `t1_integer_sum_identity`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0002`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0002/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0002/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0002",
  "condition": "A",
  "claim_id": "A0_EVAL-0002",
...
```json
{
  ...
  "proposition": "For every integer n with 1 <= n <= 50, the sum of k^1 for k = 1..n equals n(n+1)/2.",
  ...
  "argument": [
    ...
    {
      "id": "s2",
      "text": "Write F(n) = n(n+1)/2. For every n with 1 <= n <= 49, F(n+1) - F(n) = (n+1)^1, which is exactly the term added when the upper limit increases by one.",
      "depends_on": [
        "s1"
      ]
    },
    {
      "id": "s3",
      "text": "For every integer n with 2 <= n <= 50 we have n^2 >= 2n.",
      "depends_on": [
        "s1",
        "s2"
      ]
    ...
    {
      "id": "s4",
      "text": "For every integer n with 1 <= n <= 50: CONVERSE: if n is divisible by 4 then n(n+1)/2 is even. (the implication is used in the reverse direction below)",
      "depends_on": [
        "s2",
        "s3"
      ]
