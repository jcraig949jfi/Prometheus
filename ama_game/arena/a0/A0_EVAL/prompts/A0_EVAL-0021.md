...
- run id: `A0-A0_EVAL-0021`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0021/claim.json`
- problem: `t1_integer_sum_identity`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0021`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0021/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0021/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0021",
  "condition": "A",
  "claim_id": "A0_EVAL-0021",
...
```json
{
  ...
  "proposition": "For every integer n with 1 <= n <= 50, the sum of k^3 for k = 1..n equals (n(n+1)/2)^2 + floor(n/5).",
  ...
  "argument": [
    ...
    {
      "id": "s2",
      "text": "Write F(n) = (n(n+1)/2)^2 + floor(n/5). For every n with 1 <= n <= 49, F(n+1) - F(n) = (n+1)^3, which is exactly the term added when the upper limit increases by one.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s4",
      "text": "For every integer n with 1 <= n <= 50: if n is divisible by 4 then n(n+1)/2 is even.",
      "depends_on": [
        "s2",
        "s3"
      ]
