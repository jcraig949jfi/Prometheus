...
- run id: `A0-A0_EVAL-0025`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0025/claim.json`
- problem: `t2_modular_power_cycle`
- your working directory: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0025`
- your submission record: `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0025/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/A0_EVAL/runs/A0_EVAL-0025/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-A0_EVAL-0025",
  "condition": "A",
  "claim_id": "A0_EVAL-0025",
...
```json
{
  ...
  "proposition": "For every integer n with 0 <= n <= 60, 8^n is congruent to 8^(n mod 6) modulo 19.",
  ...
  "argument": [
    {
      "id": "s1",
      "text": "At n = 0 both sides equal 1 modulo 19.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "The residue 8 has order 6 modulo 19: for every n in [0, 54], 8^(n+6) is congruent to 8^n modulo 19.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s4",
      "text": "Every n in [0, 60] falls in exactly one residue class modulo 6.",
      "depends_on": [
        "s2",
        "s3"
      ]
    ...
    {
      "id": "s5",
      "text": "For every n in [0, 60]: if 6 divides n then 8^n is congruent to 1 modulo 19.",
      "depends_on": [
        "s3",
        "s4"
      ]
