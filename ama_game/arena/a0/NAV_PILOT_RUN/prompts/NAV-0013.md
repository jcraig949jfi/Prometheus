...
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/NAV_PILOT_RUN/runs/NAV-0013/claim.json`
- your working directory: `F:/Prometheus/ama_game/arena/a0/NAV_PILOT_RUN/runs/NAV-0013`
- your submission record: `F:/Prometheus/ama_game/arena/a0/NAV_PILOT_RUN/runs/NAV-0013/disposition.json`
- metered session id: `A0NAV-NAV-0013`
...
```
python F:/Prometheus/ama_game/arena/verifier/meter_cli.py remaining --session A0NAV-NAV-0013
python F:/Prometheus/ama_game/arena/verifier/meter_cli.py evaluate  --session A0NAV-NAV-0013 --point N
python F:/Prometheus/ama_game/arena/verifier/meter_cli.py sample    --session A0NAV-NAV-0013 --point N
python F:/Prometheus/ama_game/arena/verifier/meter_cli.py range     --session A0NAV-NAV-0013 --lo A --hi B
```
...
Write `F:/Prometheus/ama_game/arena/a0/NAV_PILOT_RUN/runs/NAV-0013/disposition.json`:
