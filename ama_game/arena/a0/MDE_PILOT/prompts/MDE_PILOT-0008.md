...
- run id: `A0-MDE_PILOT-0008`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0008/claim.json`
- problem: `t5_collatz_stopping_time`
- your working directory: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0008`
- your submission record: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0008/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0008/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-MDE_PILOT-0008",
  "condition": "A",
  "claim_id": "MDE_PILOT-0008",
...
```json
{
  ...
  "proposition": "Under the map n -> n/2 when n is even, n -> 3n+1 when n is odd, every integer n with 1 <= n <= 154004 reaches 1 in fewer than 311 steps.",
  "domain": "integers n with 1 <= n <= 154004",
  "quantifiers": "for all n in [1, 154004]",
  "hypotheses": [
  ...
  "argument": [
    {
      "id": "s1",
      "text": "Every n in [1, 50] has stopping time below 311; the smallest values are checked directly.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "A direct sweep verifies that every n in [1, 4286] has stopping time below 311.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s6",
      "text": "Every integer n in [1, 2000] is even or odd, so the two cases below are exhaustive.",
      "depends_on": [
        "s4",
        "s5"
      ]
    ...
    {
      "id": "s9",
      "text": "The sweep covers [1, 4286]; the statement is asserted for every n in [1, 154004].",
      "depends_on": [
        "s7",
        "s8"
      ]
