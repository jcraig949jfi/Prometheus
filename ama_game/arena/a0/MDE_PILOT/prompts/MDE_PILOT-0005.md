...
- run id: `A0-MDE_PILOT-0005`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0005/claim.json`
- problem: `t2_modular_power_cycle`
- your working directory: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0005`
- your submission record: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0005/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0005/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-MDE_PILOT-0005",
  "condition": "A",
  "claim_id": "MDE_PILOT-0005",
...
```json
{
  ...
  "proposition": "For every integer n with 0 <= n <= 40, 7^n is congruent to 7^(n mod 16) modulo 17.",
  ...
  "argument": [
    {
      "id": "s1",
      "text": "At n = 0 both sides equal 1 modulo 17.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "The residue 7 has order 16 modulo 17: for every n in [0, 24], 7^(n+16) is congruent to 7^n modulo 17.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s8",
      "text": "For every n in [0, 40]: if 16 divides n then 7^n is congruent to 1 modulo 17.",
      "depends_on": [
        "s6",
        "s7"
      ]
    ...
    {
      "id": "s10",
      "text": "Every n in [0, 40] falls in exactly one residue class modulo 16.",
      "depends_on": [
        "s8",
        "s9"
      ]
