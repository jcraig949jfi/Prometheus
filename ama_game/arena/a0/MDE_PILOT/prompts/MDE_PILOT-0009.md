...
- run id: `A0-MDE_PILOT-0009`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0009/claim.json`
- problem: `t5_collatz_stopping_time`
- your working directory: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0009`
- your submission record: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0009/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0009/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-MDE_PILOT-0009",
  "condition": "A",
  "claim_id": "MDE_PILOT-0009",
...
```json
{
  ...
  "proposition": "Under the map n -> n/2 when n is even, n -> 3n+1 when n is odd, every integer n with 1 <= n <= 337343 reaches 1 in fewer than 443 steps.",
  "domain": "integers n with 1 <= n <= 337343",
  "quantifiers": "for all n in [1, 337343]",
  "hypotheses": [
  ...
  "argument": [
    {
      "id": "s1",
      "text": "Every n in [1, 50] has stopping time below 443; the smallest values are checked directly.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "A direct sweep verifies that every n in [1, 4052] has stopping time below 443.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s8",
      "text": "The sweep covers [1, 4052]; the statement is asserted for every n in [1, 337343].",
      "depends_on": [
        "s6",
        "s7"
      ]
