...
- run id: `A0-MDE_PILOT-0004`
- condition: `A`
- claim under assessment: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0004/claim.json`
- problem: `t5_collatz_stopping_time`
- your working directory: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0004`
- your submission record: `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0004/disposition.json`
...
Write `F:/Prometheus/ama_game/arena/a0/MDE_PILOT/runs/MDE_PILOT-0004/disposition.json`:

```json
{
  "type": "DISPOSITION",
  "run_id": "A0-MDE_PILOT-0004",
  "condition": "A",
  "claim_id": "MDE_PILOT-0004",
...
```json
{
  ...
  "proposition": "Under the map n -> n/2 when n is even, n -> 3n+1 when n is odd, every integer n with 1 <= n <= 504120 reaches 1 in fewer than 386 steps.",
  "domain": "integers n with 1 <= n <= 504120",
  "quantifiers": "for all n in [1, 504120]",
  "hypotheses": [
  ...
  "argument": [
    {
      "id": "s1",
      "text": "Every n in [1, 50] has stopping time below 386; the smallest values are checked directly.",
      "depends_on": []
    },
    {
      "id": "s2",
      "text": "A direct sweep verifies that every n in [1, 1592] has stopping time below 386.",
      "depends_on": [
        "s1"
      ]
    },
    ...
    {
      "id": "s8",
      "text": "The sweep covers [1, 1592]; the statement is asserted for every n in [1, 504120].",
      "depends_on": [
        "s6",
        "s7"
      ]
