...
def live(world, mem, events, econ=None, stop_at=None, record=False):
    ...
    fill = 0
    comp = 0.0
    comp_learn = 0.0  # E1.5 instrumentation: consolidation units only (additive; behaviour unchanged)
    comp_energy = 0.0
    refused = 0
    ...
    out = dict(steps=t + 1, died=bool(energy <= 0), energy=float(energy), reward=reward,
               ...
               comp_units=comp, comp_learn=comp_learn, comp_energy=comp_energy, U=reward - comp_energy, refused=refused,
