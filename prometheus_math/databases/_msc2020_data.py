"""MSC2020 hierarchy — embedded snapshot of the AMS classification.

Source: https://msc2020.org/MSC_2020.csv (AMS / zbMATH joint maintenance).
Snapshot date: 2026-04-25.

Three flat dicts keyed by canonical code:
    TOP     — 63 entries, 2-character codes (e.g. '11' -> 'Number theory').
    SUBJECT — 534 entries, 3-character codes (e.g. '11G' -> 'Arithmetic ...').
    LEAF    — 6006 entries, 5-character codes (e.g. '11G05', '00-01').

The CSV uses '11-XX' for top, '11Gxx' for subject, '11G05' / '11-01' for
leaves; this module strips the redundant suffixes and trims the
descriptions of bracketed cross-reference annotations (the public
module API still emits raw cross-references in `extra` if needed).
"""
from __future__ import annotations

# 2-character top-level subjects.
TOP: dict[str, str] = {
    ...
    '33': 'Special functions (33-XX deals with the properties of functions as functions)',
...
# 3-character subject codes (e.g. '11G' = 'Arithmetic algebraic geometry').
SUBJECT: dict[str, str] = {
    ...
    '31E': 'Potential theory on fractals and metric spaces',
    ...
    '32P': 'Non-Archimedean analysis [Should also be assigned at least one other classification number from Section 32-XX describing the type of problem]',
    ...
    '34N': 'Dynamic equations on time scales or measure chains',
    ...
    '40F': 'Absolute and strong summability [Should also be assigned at least one other classification number in Section 40-XX]',
    '40G': 'Special methods of summability',
    '40H': 'Functional analytic methods in summability',
    '40J': 'Summability in abstract structures [Should also be assigned at least one other classification number from Section 40-XX]',
    ...
    '45B': 'Fredholm integral equations',
    ...
    '45H': 'Integral equations with miscellaneous special kernels',
    '45J': 'Integro-ordinary differential equations',
    ...
    '49R': 'Variational methods for eigenvalues of operators [Should also be assigned at least one other classification number in Section 49-XX]',
    '49S': 'Variational principles of physics [Should also be assigned at least one other classification number in Section 49-XX]',
    ...
    '51F': 'Metric geometry',
    '51G': 'Ordered geometries (ordered incidence structures, etc.)',
    ...
    '51P': 'Classical or axiomatic geometry and physics [Should also be assigned at least one other classification number from Sections 70-XX through 86-XX]',
    ...
    '65Z': 'Applications to the sciences',
    ...
    '76F': 'Turbulence',
    '76G': 'General aerodynamics and subsonic flows',
    '76H': 'Transonic flows',
    '76J': 'Supersonic flows',
    '76K': 'Hypersonic flows',
    ...
    '76P': 'Rarefied gas flows, Boltzmann equation in fluid mechanics',
    '76Q': 'Hydro- and aero-acoustics',
    '76R': 'Diffusion and convection',
    '76S': 'Flows in porous media; filtration; seepage',
    '76T': 'Multiphase and multicomponent flows',
    '76U': 'Rotating fluids',
    '76V': 'Reaction effects in flows',
    '76W': 'Magnetohydrodynamics and electrohydrodynamics',
    '76X': 'Ionized gas flow in electromagnetic fields; plasmic flow',
    '76Y': 'Quantum hydrodynamics and relativistic hydrodynamics',
    ...
    '92E': 'Chemistry',
    '92F': 'Other natural sciences (mathematical treatment)',
...
# 5-character leaf codes (the bulk of the MSC2020 hierarchy).
LEAF: dict[str, str] = {
    ...
    '46B22': 'Radon-Nikodým, Kre?n-Milman and related properties',
