...
- D-5 **contradiction cluster** ([retrieval system], relation [REF]): history advantage
...
- **D-5/D-8 contradiction ([retrieval system] [REF])**: history advantage findings contradicted
