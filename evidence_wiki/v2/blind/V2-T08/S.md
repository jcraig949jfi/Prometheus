...
[REF]: a source contributing zero verifiably-real triples is EXCLUDED, not
...
## Confound defenses
- **Fabricated-residue confound ([REF]):** any record whose "prior attempt"
...
- [REF] / [REF] -> mandated Phase 3's exact decomposition battery
  ...
  non-reasoning.
- [REF] -> set the positive-precedent ceiling ("near-perfect out-of-sample
...
- [REF] / [REF] -> decided that Phase 0/2 features must be
...
- [REF] -> added the relation/domain-disjoint split (Phase 4-ii) and
...
- [REF] -> added the fabricated-residue confound defense (exclude, never
  impute, any record without a traceable genuine prior row) and Phase 0's
  refuse-don't-render rule.
- [REF] -> directly motivated Phase 0 as a blocking gate with a numeric
...
- [REF] -> added the causal-overreach guard in Confound defenses, restricting
...
- [REF] -> added the heuristic-floor baseline (Phase 1) and falsifier 2's
