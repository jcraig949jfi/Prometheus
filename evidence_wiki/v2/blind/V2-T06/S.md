...
- [retrieval system] contradiction [REF] ([REF], D-8 blind S0
  NO_EFFECT vs [REF], D-5 blind SUPPORTED +10.95pp; classified
...
- [REF] (D6-A: relational-history-as-derived-causal-signal not
...
- [REF] (identity-level library composition carries no recoverable
