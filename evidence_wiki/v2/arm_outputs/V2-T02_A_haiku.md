...
| # | Operation | Search scope | Result | Docs opened |
|---|-----------|--------------|--------|-------------|
| 1 | Grep sanitizer | F:\Prometheus | timeout | 0 |
| 2 | Grep corpus/validation/admission | F:\Prometheus | timeout | 0 |
| 3 | Glob validation*.py | F:\Prometheus | timeout | 0 |
| 4 | Grep record | prometheus_math/ | 20 files (lehmer, mahler, tests) | 0 |
| 5 | Glob techne/**/*.md | F:\Prometheus | timeout | 0 |
| 6 | Grep validation/corpus | aporia/ | 15 files (registry, synthesis, charter, findings) | 0 |
| 7 | Read certified.py (lines 1–100) | F:\Prometheus\prometheus_math\certified.py | ball arithmetic, enclosure semantics | 1 |
| 8 | Grep training/filter/pattern | ergon/ | 12 files (validation, persistence, fingerprint, review packets) | 0 |
| 9 | Read validate_persistence.py (lines 1–80) | F:\Prometheus\ergon\gen1\validate_persistence.py | 5-check battery, schema constraints, oracle leakage | 1 |
| 10 | Read input_fingerprint.py (lines 1–80) | F:\Prometheus\ergon\gen1\input_fingerprint.py | line-ending normalization, pinned sources, frozen record | 1 |
| 11 | Grep defect/bad/corrupt/filter | ergon/ | 8 files (review packets, persistence, fingerprint, findings) | 0 |
| 12 | Read RESPONSIBILITIES.md | F:\Prometheus\ | not found | 0 |
| 13 | Bash find RESPONSIBILITIES | F:\Prometheus | no matches | 0 |
| 14 | Read FINDING_d5_reproducibility_2026-09-01.md (lines 1–100) | F:\Prometheus\ergon\gen1\ | exemption audit, defect class (checks that bypass scanning), oracle-field scans | 1 |

**Summary:** 14 operations used (1 remaining); 4 distinct documents opened (8 remaining budget).
